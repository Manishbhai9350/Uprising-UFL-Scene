 ...
 */ var it = {
  ...
  Kt = { duration: 0.5, overwrite: !1, delay: 0 },
  Je,
  W,
  z,
  at = 1e8,
  ...
  $r = { _start: 0, endTime: ae, totalDuration: ae },
  nt = function f(t, e, i) {
    var r = t.labels,
      n = t._recent || $r,
    ...
    return (
      ...
      (t.startTime = function (i) {
        if (arguments.length) {
          ...
          return (
            r && (r._sort || !this.parent) && _t(r, this, i - this._delay),
            this
          );
        }
        return this._start;
  ...
  function t(i, r, n, s) {
    ...
    if (
      ...
      if (
        ...
        (re(ft(T.vars.defaults, { ease: "none" })),
...
ft(U.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 });
...
var Ar = {
  ...
  core: { _removeProperty: he, _getMatrix: pi },
};
