 ...
 */ var Sd = P,
  ...
  wd = Sd.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function uu(n, r, l) {
  ...
  for (a in r) _d.call(r, a) && !Td.hasOwnProperty(a) && (c[a] = r[a]);
  if (n && n.defaultProps)
...
l0=max(minLuminance,l0);l1=max(minLuminance,l1);float adaptedLum=l0+(l1-l0)*(1.0-exp(-deltaTime*tau));gl_FragColor=(adaptedLum==1.0)?vec4(1.0):packFloatToRGBA(adaptedLum);}`,
  ...
  Ie = "srgb",
  An = "srgb-linear",
  Pt = { NONE: 0, DEPTH: 1, CONVOLUTION: 2 },
  he = {
  ...
  yl = { VERY_SMALL: 0, SMALL: 1, MEDIUM: 2, LARGE: 3, VERY_LARGE: 4, HUGE: 5 },
  Pd = { SCALE_UP: "lut.scaleup" },
  Bt = {
    REINHARD: 0,
    REINHARD2: 1,
  ...
  gi = { DEFAULT: 0, ESKIL: 1 },
  fu = Number(Ri.replace(/\D+/g, "")),
  Sl = fu >= 152,
  du = new Map([
    [ru, An],
    [hl, Ie],
...
function Bn(n) {
  return n === null ? null : Sl ? n.outputColorSpace : du.get(n.outputEncoding);
}
function yt(n, r) {
  n !== null && (Sl ? (n.colorSpace = r) : (n.encoding = Cd.get(r)));
}
function Ws(n, r) {
  n === null ||
    r === null ||
    (Sl ? (r.colorSpace = n.colorSpace) : (r.encoding = n.encoding));
}
function Sr(n) {
  return fu < 154 ? n.replace("colorspace_fragment", "encodings_fragment") : n;
}
var Ud = `#ifdef FRAMEBUFFER_PRECISION_HIGH
...
#include <colorspace_fragment>
  ...
  Id = class extends St {
    ...
    setTexelSize(n, r) {
      this.uniforms.texelSize.value.set(n, r, n * 0.5, r * 0.5);
    }
    setSize(n, r) {
      const l = 1 / n,
        a = 1 / r;
      this.uniforms.texelSize.value.set(l, a, l * 0.5, a * 0.5);
    }
  },
  zd = `#include <common>
...
#include <dithering_fragment>
  ...
  hu = class extends St {
    constructor() {
      (super({
        name: "CopyMaterial",
        uniforms: { inputBuffer: new Q(null), opacity: new Q(1) },
        blending: Ot,
        toneMapped: !1,
        depthWrite: !1,
        depthTest: !1,
...
gl_FragColor=vec4(n[index],d[index]);}`,
  ...
  Od = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
  ...
  Fd = class extends St {
    constructor() {
      (super({
        ...
        uniforms: { inputBuffer: new Q(null), texelSize: new Q(new Se()) },
        blending: Ot,
        toneMapped: !1,
        depthWrite: !1,
        depthTest: !1,
...
#include <dithering_fragment>
  ...
  jd = class extends St {
    ...
    setShaderParts(n) {
      return (
        (this.fragmentShader = Hd.replace(
          he.FRAGMENT_HEAD,
          n.get(he.FRAGMENT_HEAD) || "",
        )
          .replace(he.FRAGMENT_MAIN_UV, n.get(he.FRAGMENT_MAIN_UV) || "")
          .replace(
            he.FRAGMENT_MAIN_IMAGE,
            n.get(he.FRAGMENT_MAIN_IMAGE) || "",
          )),
        (this.vertexShader = Gd.replace(
          he.VERTEX_HEAD,
          n.get(he.VERTEX_HEAD) || "",
        ).replace(he.VERTEX_MAIN_SUPPORT, n.get(he.VERTEX_MAIN_SUPPORT) || "")),
        (this.fragmentShader = Sr(this.fragmentShader)),
        (this.needsUpdate = !0),
        this
      );
    ...
    setSize(n, r) {
      ...
      (l.resolution.value.set(n, r),
        l.texelSize.value.set(1 / n, 1 / r),
        (l.aspect.value = n / r));
    }
    static get Section() {
      return he;
...
gl_FragColor=vec4(l);
  ...
  Vd = class extends St {
    constructor(n = !1, r = null) {
      (super({
        ...
        defines: { THREE_REVISION: Ri.replace(/\D+/g, "") },
        uniforms: {
          inputBuffer: new Q(null),
          threshold: new Q(0),
          smoothing: new Q(1),
  ...
  Wd = `#ifdef FRAMEBUFFER_PRECISION_HIGH
...
function Yd() {
  if (Kt === null) {
    ...
    ((Kt = new ml()),
      Kt.setAttribute !== void 0
        ? (Kt.setAttribute("position", new In(n, 3)),
          Kt.setAttribute("uv", new In(r, 2)))
        : (Kt.addAttribute("position", new In(n, 3)),
          Kt.addAttribute("uv", new In(r, 2))));
  }
  return Kt;
}
var qe = class pu {
    constructor(r = "Pass", l = new pr(), a = Kd) {
      ((this.name = r),
        (this.renderer = null),
        (this.scene = l),
        (this.camera = a),
    ...
    set fullscreenMaterial(r) {
      ...
      l !== null
        ...
        : ((l = new su(Yd(), r)),
          (l.frustumCulled = !1),
          this.scene === null && (this.scene = new pr()),
          this.scene.add(l),
          (this.screen = l));
    }
  ...
  vu = class extends qe {
    constructor(n, r = !0) {
      (super("CopyPass"),
        (this.fullscreenMaterial = new hu()),
        (this.needsSwap = !1),
        (this.renderTarget = n),
        n === void 0 &&
    ...
    render(n, r, l, a, c) {
      ((this.fullscreenMaterial.inputBuffer = r.texture),
    ...
    initialize(n, r, l) {
      l !== void 0 &&
        ((this.renderTarget.texture.type = l),
        l !== Ct
          ? (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1")
          : Bn(n) === Ie && yt(this.renderTarget.texture, Ie));
    }
  },
  Zd = class extends qe {
    constructor(n, { minLuminance: r = 0.01, adaptationRate: l = 1 } = {}) {
      (super("AdaptiveLuminancePass"),
        (this.fullscreenMaterial = new Rd()),
        (this.needsSwap = !1),
        (this.renderTargetPrevious = new rt(1, 1, {
          minFilter: Jt,
          magFilter: Jt,
          depthBuffer: !1,
        })),
      ...
      ((a.luminanceBuffer0 = this.renderTargetPrevious.texture),
        (a.luminanceBuffer1 = n),
        (a.minLuminance = r),
        (a.adaptationRate = l),
        (this.renderTargetAdapted = this.renderTargetPrevious.clone()),
        (this.renderTargetAdapted.texture.name = "Luminance.Adapted"),
        (this.copyPass = new vu(this.renderTargetPrevious, !1)));
    }
    get texture() {
    ...
    render(n, r, l, a, c) {
      ((this.fullscreenMaterial.deltaTime = a),
        n.setRenderTarget(
          this.renderToScreen ? null : this.renderTargetAdapted,
        ),
        n.render(this.scene, this.camera),
        this.copyPass.render(n, this.renderTargetAdapted));
    }
  },
  qd = class extends qe {
    constructor() {
  ...
  mu = class extends qe {
    ...
    render(n, r, l, a, c) {
      const d = this.overrideClearColor,
        ...
        y = f >= 0;
      (p
        ? (n.getClearColor(Ma), n.setClearColor(d, y ? f : g))
        : y && n.setClearAlpha(f),
        n.setRenderTarget(this.renderToScreen ? null : r),
        n.clear(this.color, this.depth, this.stencil),
        p ? n.setClearColor(Ma, g) : y && n.setClearAlpha(g));
    }
  },
  gu = class extends qe {
    constructor(n, r, l = null) {
      (super("RenderPass", n, r),
        (this.needsSwap = !1),
        (this.clearPass = new mu()),
        (this.overrideMaterialManager = l === null ? null : new Pa(l)),
    ...
    set overrideMaterial(n) {
      ...
      n !== null
        ? r !== null
          ? r.setMaterial(n)
          : (this.overrideMaterialManager = new Pa(n))
        : r !== null && (r.dispose(), (this.overrideMaterialManager = null));
    }
    getOverrideMaterial() {
    ...
    render(n, r, l, a, c) {
      const d = this.scene,
        ...
        h = this.renderToScreen ? null : r;
      (g !== null && f.layers.set(g.getLayer()),
        this.skipShadowMapUpdate && (n.shadowMap.autoUpdate = !1),
        (this.ignoreBackground || this.clearPass.overrideClearColor !== null) &&
          (d.background = null),
        this.clearPass.enabled && this.clearPass.render(n, r),
        n.setRenderTarget(h),
        this.overrideMaterialManager !== null
          ? this.overrideMaterialManager.render(n, d, f)
          : n.render(d, f),
        (f.layers.mask = p),
        (d.background = y),
        (n.shadowMap.autoUpdate = v));
    }
  },
  Jd = class extends qe {
    constructor({
    ...
    setDepthTexture(n, r = On) {
      ((this.fullscreenMaterial.depthBuffer = n),
        (this.fullscreenMaterial.depthPacking = r));
    }
    render(n, r, l, a, c) {
      (n.setRenderTarget(this.renderToScreen ? null : this.renderTarget),
        n.render(this.scene, this.camera));
    ...
    setSize(n, r) {
      ...
      (l.setBaseSize(n, r),
        this.renderTarget.setSize(l.width, l.height),
...
function Ra(n, r, l) {
  for (const a of r) {
    ...
    for (const f of l.entries())
      f[1] !== null && l.set(f[0], f[1].replace(d, c));
  }
}
function $d(n, r, l) {
  ...
  if (((l.attributes |= r.getAttributes()), a === void 0))
    throw new Error(`Missing fragment shader (${r.name})`);
  if (f && l.attributes & Pt.CONVOLUTION)
    throw new Error(
      `Effects that transform UVs are incompatible with convolution effects (${r.name})`,
    );
  if (!d && !f)
    throw new Error(`Could not find mainImage or mainUv function (${r.name})`);
  {
    const g = /\w+\s+(\w+)\([\w\s,]*\)\s*{/g,
      p = l.shaderParts;
    let y = p.get(he.FRAGMENT_HEAD) || "",
      v = p.get(he.FRAGMENT_MAIN_UV) || "",
      h = p.get(he.FRAGMENT_MAIN_IMAGE) || "",
      S = p.get(he.VERTEX_HEAD) || "",
      x = p.get(he.VERTEX_MAIN_SUPPORT) || "";
    const w = new Set(),
      z = new Set();
    if (
      (f &&
        ((v += `	${n}MainUv(UV);
`),
        (l.uvTransformation = !0)),
      c !== null && /mainSupport/.test(c))
    ) {
...
`));
      for (const D of c.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))
        for (const H of D[1].split(/\s*,\s*/))
          (l.varyings.add(H), w.add(H), z.add(H));
    ...
    (z.delete("while"),
      z.delete("for"),
      z.delete("if"),
      r.uniforms.forEach((T, D) =>
        l.uniforms.set(n + D.charAt(0).toUpperCase() + D.slice(1), T),
      ),
      r.defines.forEach((T, D) =>
        l.defines.set(n + D.charAt(0).toUpperCase() + D.slice(1), T),
      ));
    const I = new Map([
      ["fragment", a],
      ["vertex", c],
    ...
    if ((l.blendModes.set(C.blendFunction, C), d)) {
      (r.inputColorSpace !== null &&
        r.inputColorSpace !== l.colorSpace &&
        (h +=
          r.inputColorSpace === Ie
            ? `color0 = LinearTosRGB(color0);
	`
            : `color0 = sRGBToLinear(color0);
	`),
        r.outputColorSpace !== cu
          ? (l.colorSpace = r.outputColorSpace)
          : r.inputColorSpace !== null && (l.colorSpace = r.inputColorSpace));
      const T = /MainImage *\([\w\s,]*?depth[\w\s,]*?\)/;
      ((h += `${n}MainImage(color0, UV, `),
        l.attributes & Pt.DEPTH &&
          T.test(a) &&
          ((h += "depth, "), (l.readDepth = !0)),
        (h += `color1);
	`));
      const D = n + "BlendOpacity";
      (l.uniforms.set(D, C.opacity),
        (h += `color0 = blend${C.blendFunction}(color0, color1, ${D});
...
`),
      c !== null &&
        (S +=
          ...
          `
`),
      p.set(he.FRAGMENT_HEAD, y),
      p.set(he.FRAGMENT_MAIN_UV, v),
      p.set(he.FRAGMENT_MAIN_IMAGE, h),
      p.set(he.VERTEX_HEAD, S),
      p.set(he.VERTEX_MAIN_SUPPORT, x),
      r.extensions !== null)
    )
      for (const T of r.extensions) l.extensions.add(T);
  }
}
var eh = class extends qe {
    constructor(n, ...r) {
      (super("EffectPass"),
        (this.fullscreenMaterial = new jd(null, null, null, n)),
        (this.listener = (l) => this.handleEvent(l)),
        (this.effects = []),
        this.setEffects(r),
    ...
    updateMaterial() {
      ...
      for (const f of this.effects)
        if (f.blendMode.blendFunction === ie.DST)
          n.attributes |= f.getAttributes() & Pt.DEPTH;
        else {
          if (n.attributes & f.getAttributes() & Pt.CONVOLUTION)
            throw new Error(`Convolution effects cannot be merged (${f.name})`);
          $d("e" + r++, f, n);
        }
      ...
      const d = /\bblend\b/g;
      for (const f of n.blendModes.values())
        l +=
          f.getShaderCode().replace(d, `blend${f.blendFunction}`) +
          `
`;
      (n.attributes & Pt.DEPTH
        ? (n.readDepth &&
            (a =
...
` + c),
        ...
        n.shaderParts.set(he.FRAGMENT_HEAD, l),
        n.shaderParts.set(he.FRAGMENT_MAIN_IMAGE, a),
        n.shaderParts.set(he.FRAGMENT_MAIN_UV, c));
      for (const [f, g] of n.shaderParts)
        g !== null &&
          n.shaderParts.set(
            f,
            g.trim().replace(
...
#`,
    ...
    render(n, r, l, a, c) {
      ...
      if (!this.skipRendering || this.renderToScreen) {
        ...
        ((d.inputBuffer = r.texture),
          (d.time += a * this.timeScale),
          n.setRenderTarget(this.renderToScreen ? null : l),
          n.render(this.scene, this.camera));
      }
    }
    setSize(n, r) {
  ...
  th = class extends qe {
    constructor({
      ...
      (super("KawaseBlurPass"),
        (this.renderTargetA = new rt(1, 1, { depthBuffer: !1 })),
      ...
      (f.addEventListener("change", (g) =>
        ...
        (this._blurMaterial = new Id()),
        (this._blurMaterial.kernelSize = n),
        (this.copyMaterial = new hu()));
    }
    getResolution() {
      return this.resolution;
    }
    ...
    setSize(n, r) {
      ...
      const a = l.width,
        c = l.height;
      (this.renderTargetA.setSize(a, c),
        this.renderTargetB.setSize(a, c),
        this.blurMaterial.setSize(n, r));
    }
    initialize(n, r, l) {
      l !== void 0 &&
        ((this.renderTargetA.texture.type = l),
        (this.renderTargetB.texture.type = l),
        l !== Ct
          ? ((this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1"),
            (this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1"))
          : Bn(n) === Ie &&
            (yt(this.renderTargetA.texture, Ie),
            yt(this.renderTargetB.texture, Ie)));
    }
  ...
  yu = class extends qe {
    constructor({
      ...
      (super("LuminancePass"),
        (this.fullscreenMaterial = new Vd(l, r)),
        (this.needsSwap = !1),
        (this.renderTarget = n),
        this.renderTarget === void 0 &&
          ((this.renderTarget = new rt(1, 1, { depthBuffer: !1 })),
          (this.renderTarget.texture.name = "LuminancePass.Target")));
      const p = (this.resolution = new be(this, f, g, a));
  ...
  nh = class extends qe {
    ...
    render(n, r, l, a, c) {
      ...
      (f.color.setMask(!1),
        ...
        f.depth.setLocked(!0),
        f.stencil.setTest(!0),
        f.stencil.setOp(d.REPLACE, d.REPLACE, d.REPLACE),
        f.stencil.setFunc(d.ALWAYS, v, 4294967295),
        f.stencil.setClear(h),
        f.stencil.setLocked(!0),
        this.clearPass.enabled &&
          (this.renderToScreen
            ? y.render(n, null)
            : (y.render(n, r), y.render(n, l))),
        this.renderToScreen
          ? (n.setRenderTarget(null), n.render(g, p))
          : (n.setRenderTarget(r),
            n.render(g, p),
            n.setRenderTarget(l),
            n.render(g, p)),
        f.color.setLocked(!1),
        f.depth.setLocked(!1),
        f.stencil.setLocked(!1),
        f.stencil.setFunc(d.EQUAL, 1, 4294967295),
        f.stencil.setOp(d.KEEP, d.KEEP, d.KEEP),
        f.stencil.setLocked(!0));
    }
  },
  rh = class extends qe {
    constructor() {
      (super("MipmapBlurPass"),
        ...
        (this.downsamplingMaterial = new Fd()),
        (this.upsamplingMaterial = new Xd()),
        (this.resolution = new Se()));
    }
    get texture() {
      return this.renderTarget.texture;
    }
    ...
    set levels(n) {
      if (this.levels !== n) {
        ...
        for (let l = 0; l < n; ++l) {
          const a = r.clone();
          ((a.texture.name = "Downsampling.Mipmap" + l),
            this.downsamplingMipmaps.push(a));
        }
        this.upsamplingMipmaps.push(r);
        for (let l = 1, a = n - 1; l < a; ++l) {
          const c = r.clone();
          ((c.texture.name = "Upsampling.Mipmap" + l),
    ...
    render(n, r, l, a, c) {
      const { scene: d, camera: f } = this,
        { downsamplingMaterial: g, upsamplingMaterial: p } = this,
        { downsamplingMipmaps: y, upsamplingMipmaps: v } = this;
      let h = r;
      this.fullscreenMaterial = g;
      for (let S = 0, x = y.length; S < x; ++S) {
        const w = y[S];
        (g.setSize(h.width, h.height),
          (g.inputBuffer = h.texture),
          n.setRenderTarget(w),
          n.render(d, f),
          (h = w));
      }
      ...
      for (let S = v.length - 1; S >= 0; --S) {
        const x = v[S];
        (p.setSize(h.width, h.height),
          (p.inputBuffer = h.texture),
          (p.supportBuffer = y[S].texture),
          n.setRenderTarget(x),
          n.render(d, f),
          (h = x));
      }
    ...
    setSize(n, r) {
      ...
      let a = l.width,
        c = l.height;
      for (let d = 0, f = this.downsamplingMipmaps.length; d < f; ++d)
        ((a = Math.round(a * 0.5)),
          (c = Math.round(c * 0.5)),
          this.downsamplingMipmaps[d].setSize(a, c),
          d < this.upsamplingMipmaps.length &&
            this.upsamplingMipmaps[d].setSize(a, c));
    }
    initialize(n, r, l) {
      if (l !== void 0) {
        ...
        else if (Bn(n) === Ie) for (const c of a) yt(c.texture, Ie);
      }
    }
    dispose() {
      super.dispose();
  ...
  ih = class extends qe {
    constructor(
      ...
      (super("NormalPass"),
        (this.needsSwap = !1),
        (this.renderPass = new gu(n, r, new Gf())));
      const p = this.renderPass;
      ((p.ignoreBackground = !0), (p.skipShadowMapUpdate = !0));
      const y = p.getClearPass();
      ((y.overrideClearColor = new yr(7829503)),
        (y.overrideClearAlpha = 1),
        (this.renderTarget = l),
        this.renderTarget === void 0 &&
          ((this.renderTarget = new rt(1, 1, { minFilter: Jt, magFilter: Jt })),
          (this.renderTarget.texture.name = "NormalPass.Target")));
      const v = (this.resolution = new be(this, f, g, a));
      v.addEventListener("change", (h) =>
        this.setSize(v.baseWidth, v.baseHeight),
      );
    }
    set mainScene(n) {
  ...
  oh = class {
    constructor(
      ...
      ((this.renderer = null),
        (this.inputBuffer = this.createBuffer(l, a, d, c)),
        (this.outputBuffer = this.inputBuffer.clone()),
        (this.copyPass = new vu()),
    ...
    setRenderer(r) {
      if (((this.renderer = r), r !== null)) {
        ...
        (c === Ct &&
          Bn(r) === Ie &&
          (yt(this.inputBuffer.texture, Ie),
          yt(this.outputBuffer.texture, Ie),
          this.inputBuffer.dispose(),
          this.outputBuffer.dispose()),
          (r.autoClear = !1),
    ...
    replaceRenderer(r, l = !0) {
      ...
      return (
        ...
        l &&
          c !== null &&
          (c.removeChild(a.domElement), c.appendChild(r.domElement)),
        a
      );
    }
    createDepthTexture() {
      const r = (this.depthTexture = new jf());
      return (
        (this.inputBuffer.depthTexture = r),
        this.inputBuffer.dispose(),
        this.inputBuffer.stencilBuffer
          ? ((r.format = bf), (r.type = Vf))
          : (r.type = Wf),
        r
      );
    }
    ...
    createBuffer(r, l, a, c) {
      const d = this.renderer,
        ...
        p = new rt(f.width, f.height, g);
      return (
        c > 0 && ((p.ignoreDepthForMultisampleCopy = !1), (p.samples = c)),
        a === Ct && Bn(d) === Ie && yt(p.texture, Ie),
        (p.texture.name = "EffectComposer.Buffer"),
    ...
    addPass(r, l) {
      ...
      if (
        ...
        this.autoRenderToScreen &&
          (a.length > 0 && (a[a.length - 1].renderToScreen = !1),
          r.renderToScreen && (this.autoRenderToScreen = !1)),
        l !== void 0 ? a.splice(l, 0, r) : a.push(r),
        this.autoRenderToScreen && (a[a.length - 1].renderToScreen = !0),
        r.needsDepthTexture || this.depthTexture !== null)
      )
        if (this.depthTexture === null) {
          const p = this.createDepthTexture();
          for (r of a) r.setDepthTexture(p);
    ...
    removePass(r) {
      ...
      if (a !== -1 && l.splice(a, 1).length > 0) {
        if (this.depthTexture !== null) {
          const f = (p, y) => p || y.needsDepthTexture;
          l.reduce(f, !1) ||
    ...
    render(r) {
      ...
      for (const v of this.passes)
        v.enabled &&
          (v.render(l, c, d, r, f),
          v.needsSwap &&
            (f &&
              ((a.renderToScreen = v.renderToScreen),
              (g = l.getContext()),
              (p = l.state.buffers.stencil),
              p.setFunc(g.NOTEQUAL, 1, 4294967295),
              a.render(l, c, d, r, f),
              p.setFunc(g.EQUAL, 1, 4294967295)),
            (y = c),
            (c = d),
            (d = y)),
          v instanceof nh ? (f = !0) : v instanceof qd && (f = !1));
    }
    setSize(r, l, a) {
      const c = this.renderer,
        d = c.getSize(new Se());
      ((r === void 0 || l === void 0) && ((r = d.width), (l = d.height)),
        (d.width !== r || d.height !== l) && c.setSize(r, l, a));
      const f = c.getDrawingBufferSize(new Se());
      (this.inputBuffer.setSize(f.width, f.height),
        this.outputBuffer.setSize(f.width, f.height));
  ...
  Pa = class {
    constructor(n = null) {
      ((this.originalMaterials = new Map()),
        ...
        this.setMaterial(n),
        (this.meshCount = 0),
        (this.replaceMaterial = (r) => {
          if (r.isMesh) {
            let l;
            if (r.material.flatShading)
              switch (r.material.side) {
                case mi:
            ...
            (this.originalMaterials.set(r, r.material),
              r.isSkinnedMesh
                ? (r.material = l[2])
                : r.isInstancedMesh
                  ? (r.material = l[1])
    ...
    cloneMaterial(n) {
      ...
      const a = n.clone();
      for (const c of l)
        ((r[c[0]].value = c[1]), (a.uniforms[c[0]].value = c[1]));
      return a;
    }
    setMaterial(n) {
      if ((this.disposeMaterials(), (this.material = n), n !== null)) {
        ...
        for (const l of r)
          ((l.uniforms = Object.assign({}, n.uniforms)), (l.side = Qf));
        ((r[2].skinning = !0),
          (this.materialsBackSide = r.map((l) => {
            const a = this.cloneMaterial(l);
            return (
              (a.uniforms = Object.assign({}, n.uniforms)),
              (a.side = vi),
              a
            );
          })),
  ...
  be = class extends cl {
    constructor(n, r = Yt, l = Yt, a = 1) {
      (super(),
        (this.resizable = n),
        (this.baseSize = new Se(1, 1)),
        (this.preferredSize = new Se(r, l)),
        (this.target = this.preferredSize),
        (this.s = a),
        (this.effectiveSize = new Se()),
    ...
    updateEffectiveSize() {
      ...
      (r.width !== Yt
        ? (l.width = r.width)
        : r.height !== Yt
          ? (l.width = Math.round(r.height * (n.width / Math.max(n.height, 1))))
          : (l.width = Math.round(n.width * a)),
        r.height !== Yt
          ? (l.height = r.height)
          : r.width !== Yt
            ? (l.height = Math.round(
                r.width / Math.max(n.width / Math.max(n.height, 1), 1),
              ))
            : (l.height = Math.round(n.height * a)));
    }
    get width() {
    ...
    set scale(n) {
      this.s !== n &&
        ((this.s = n),
        this.preferredSize.setScalar(Yt),
    ...
    setBaseSize(n, r) {
      (this.baseSize.width !== n || this.baseSize.height !== r) &&
        (this.baseSize.set(n, r),
        this.dispatchEvent({ type: "change" }),
        this.resizable.setSize(this.baseSize.width, this.baseSize.height));
    }
    get preferredWidth() {
    ...
    setPreferredSize(n, r) {
      (this.preferredSize.width !== n || this.preferredSize.height !== r) &&
        (this.preferredSize.set(n, r),
        this.dispatchEvent({ type: "change" }),
        this.resizable.setSize(this.baseSize.width, this.baseSize.height));
    }
    copy(n) {
  ...
  jh = class extends cl {
    ...
    getShaderCode() {
      return Gh.get(this.blendFunction);
    }
  },
  $t = class extends cl {
    constructor(
      ...
      (super(),
        ...
        (this.uniforms = d),
        (this.extensions = f),
        (this.blendMode = new jh(a)),
        this.blendMode.addEventListener("change", (p) => this.setChanged()),
        (this._inputColorSpace = An),
        (this._outputColorSpace = cu));
    }
    get inputColorSpace() {
  ...
  bh = `#ifdef FRAMEBUFFER_PRECISION_HIGH
...
uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec4 texel=texture2D(map,uv);outputColor=vec4(texel.rgb*intensity,texel.a);}`,
  Vh = class extends $t {
    constructor({
      ...
      luminanceThreshold: r = 0.9,
      luminanceSmoothing: l = 0.025,
      mipmapBlur: a = !1,
      intensity: c = 1,
      radius: d = 0.85,
      levels: f = 8,
      ...
      (super("BloomEffect", bh, {
        ...
        (this.blurPass = new th({ kernelSize: g })),
        (this.luminancePass = new yu({ colorOutput: !0 })),
        (this.luminanceMaterial.threshold = r),
        (this.luminanceMaterial.smoothing = l),
        (this.mipmapBlurPass = new rh()),
        (this.mipmapBlurPass.enabled = a),
        (this.mipmapBlurPass.radius = d),
        (this.mipmapBlurPass.levels = f),
        (this.uniforms.get("map").value = a
          ? this.mipmapBlurPass.texture
          : this.renderTarget.texture));
      const x = (this.resolution = new be(this, h, S, p));
      x.addEventListener("change", (w) =>
        this.setSize(x.baseWidth, x.baseHeight),
      );
    }
    get texture() {
      ...
      c.enabled
        ? (c.render(n, r),
          this.mipmapBlurPass.enabled
            ? this.mipmapBlurPass.render(n, c.renderTarget)
            : this.blurPass.render(n, c.renderTarget, a))
        : this.mipmapBlurPass.enabled
          ? this.mipmapBlurPass.render(n, r)
          : this.blurPass.render(n, r, a);
    }
    setSize(n, r) {
      const l = this.resolution;
      (l.setBaseSize(n, r),
        this.renderTarget.setSize(l.width, l.height),
        this.blurPass.resolution.copy(l),
        this.luminancePass.setSize(n, r),
        this.mipmapBlurPass.setSize(n, r));
    }
    initialize(n, r, l) {
      (this.blurPass.initialize(n, r, l),
        this.luminancePass.initialize(n, r, l),
        this.mipmapBlurPass.initialize(n, r, l),
        l !== void 0 &&
          ((this.renderTarget.texture.type = l),
          Bn(n) === Ie && yt(this.renderTarget.texture, Ie)));
    }
...
var Wh = class Su {
    ...
    toCanvas() {
      return typeof document > "u"
        ? null
        : Ca(this.width, this.height, this.data);
    }
    static from(r) {
  ...
  Qh = `"use strict";(()=>{var O={SCALE_UP:"lut.scaleup"};var _=[new Float32Array(3),new Float32Array(3)],n=[new Float32Array(3),new Float32Array(3),new Float32Array(3),new Float32Array(3)],Z=[[new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1])]];function d(a,t,r,m){let i=r[0]-t[0],e=r[1]-t[1],y=r[2]-t[2],h=a[0]-t[0],A=a[1]-t[1],w=a[2]-t[2],c=e*w-y*A,l=y*h-i*w,x=i*A-e*h,u=Math.sqrt(c*c+l*l+x*x),b=u*.5,s=c/u,F=l/u,f=x/u,p=-(a[0]*s+a[1]*F+a[2]*f),M=m[0]*s+m[1]*F+m[2]*f;return Math.abs(M+p)*b/3}function V(a,t,r,m,i,e){let y=(r+m*t+i*t*t)*4;e[0]=a[y+0],e[1]=a[y+1],e[2]=a[y+2]}function k(a,t,r,m,i,e){let y=r*(t-1),h=m*(t-1),A=i*(t-1),w=Math.floor(y),c=Math.floor(h),l=Math.floor(A),x=Math.ceil(y),u=Math.ceil(h),b=Math.ceil(A),s=y-w,F=h-c,f=A-l;if(w===y&&c===h&&l===A)V(a,t,y,h,A,e);else{let p;s>=F&&F>=f?p=Z[0]:s>=f&&f>=F?p=Z[1]:f>=s&&s>=F?p=Z[2]:F>=s&&s>=f?p=Z[3]:F>=f&&f>=s?p=Z[4]:f>=F&&F>=s&&(p=Z[5]);let[M,g,X,Y]=p,P=_[0];P[0]=s,P[1]=F,P[2]=f;let o=_[1],L=x-w,S=u-c,U=b-l;o[0]=L*M[0]+w,o[1]=S*M[1]+c,o[2]=U*M[2]+l,V(a,t,o[0],o[1],o[2],n[0]),o[0]=L*g[0]+w,o[1]=S*g[1]+c,o[2]=U*g[2]+l,V(a,t,o[0],o[1],o[2],n[1]),o[0]=L*X[0]+w,o[1]=S*X[1]+c,o[2]=U*X[2]+l,V(a,t,o[0],o[1],o[2],n[2]),o[0]=L*Y[0]+w,o[1]=S*Y[1]+c,o[2]=U*Y[2]+l,V(a,t,o[0],o[1],o[2],n[3]);let T=d(g,X,Y,P)*6,q=d(M,X,Y,P)*6,C=d(M,g,Y,P)*6,E=d(M,g,X,P)*6;n[0][0]*=T,n[0][1]*=T,n[0][2]*=T,n[1][0]*=q,n[1][1]*=q,n[1][2]*=q,n[2][0]*=C,n[2][1]*=C,n[2][2]*=C,n[3][0]*=E,n[3][1]*=E,n[3][2]*=E,e[0]=n[0][0]+n[1][0]+n[2][0]+n[3][0],e[1]=n[0][1]+n[1][1]+n[2][1]+n[3][1],e[2]=n[0][2]+n[1][2]+n[2][2]+n[3][2]}}var v=class{static expand(t,r){let m=Math.cbrt(t.length/4),i=new Float32Array(3),e=new t.constructor(r**3*4),y=t instanceof Uint8Array?255:1,h=r**2,A=1/(r-1);for(let w=0;w<r;++w)for(let c=0;c<r;++c)for(let l=0;l<r;++l){let x=l*A,u=c*A,b=w*A,s=Math.round(l+c*r+w*h)*4;k(t,m,x,u,b,i),e[s+0]=i[0],e[s+1]=i[1],e[s+2]=i[2],e[s+3]=y}return e}};self.addEventListener("message",a=>{let t=a.data,r=t.data;switch(t.operation){case O.SCALE_UP:r=v.expand(r,t.size);break}postMessage(r,[r.buffer]),close()});})();
`,
  Ua = new yr(),
  xu = class _i extends xi {
    constructor(r, l) {
      (super(r, l, l, l),
        (this.type = Nt),
        (this.format = Ei),
        ...
        (this.needsUpdate = !0),
        yt(this, An),
        (this.domainMin = new Ne(0, 0, 0)),
        (this.domainMax = new Ne(1, 1, 1)));
    }
        ...
        r <= a.width
          ...
          : (c = new Promise((d, f) => {
              const g = URL.createObjectURL(
                  new Blob([Qh], { type: "text/javascript" }),
                ),
                p = new Worker(g);
              (p.addEventListener("error", (v) => f(v.error)),
                p.addEventListener("message", (v) => {
                  const h = new _i(v.data, r);
                  (Ws(this, h),
                    (h.type = this.type),
                    (h.name = this.name),
              ...
              p.postMessage(
                { operation: Pd.SCALE_UP, data: a.data, size: r },
                y,
              );
            })),
        c
    ...
    applyLUT(r) {
      ...
      if (c !== d) console.error("Size mismatch");
      else if (r.type !== Nt || this.type !== Nt)
        console.error("Both LUTs must be FloatType textures");
      else if (r.format !== Ei || this.format !== Ei)
        ...
        const f = l.data,
          ...
          y = p ** 2,
          v = p - 1;
        for (let h = 0, S = p ** 3; h < S; ++h) {
          const x = h * 4,
            w = f[x + 0] * v,
            z = f[x + 1] * v,
            I = f[x + 2] * v,
            C = Math.round(w + z * p + I * y) * 4;
    ...
    convertToUint8() {
      if (this.type === Nt) {
        ...
        for (let a = 0, c = r.length; a < c; ++a) l[a] = r[a] * 255 + 0.5;
    ...
    convertLinearToSRGB() {
      const r = this.image.data;
      if (this.type === Nt) {
        for (let l = 0, a = r.length; l < a; l += 4)
          Ua.fromArray(r, l).convertLinearToSRGB().toArray(r, l);
    ...
    convertSRGBToLinear() {
      ...
      if (this.type === Nt) {
        for (let l = 0, a = r.length; l < a; l += 4)
          Ua.fromArray(r, l).convertSRGBToLinear().toArray(r, l);
    ...
    static from(r) {
      ...
      if (l instanceof Image) {
        const y = Wh.from(l).data;
        if (a > c) {
          f = new Uint8Array(y.length);
          for (let v = 0; v < d; ++v)
            for (let h = 0; h < d; ++h)
              for (let S = 0; S < d; ++S) {
                const x = (S + v * d + h * d * d) * 4,
                  w = (S + h * d + v * d * d) * 4;
                ((f[w + 0] = y[x + 0]),
                  (f[w + 1] = y[x + 1]),
                  (f[w + 2] = y[x + 2]),
  ...
  Yh = `uniform vec3 scale;uniform vec3 offset;
...
outputColor=vec4(c,inputColor.a);}`,
  Zh = class extends $t {
    constructor(
      ...
      (super("LUT3DEffect", Yh, {
        ...
        (this.tetrahedralInterpolation = l),
        (this.inputColorSpace = c || du.get(a)),
        (this.lut = n));
    }
    get inputEncoding() {
    ...
    set lut(n) {
      ...
      if (this.lut !== n && ((l.get("lut").value = n), n !== null)) {
        ...
        if (
          (r.clear(),
          r.set("LUT_SIZE", Math.min(a.width, a.height).toFixed(16)),
          r.set("LUT_TEXEL_WIDTH", (1 / a.width).toFixed(16)),
          r.set("LUT_TEXEL_HEIGHT", (1 / a.height).toFixed(16)),
          (l.get("domainMin").value = null),
          (l.get("domainMax").value = null),
          (n.type === Nt || n.type === pl) && r.set("LUT_PRECISION_HIGH", "1"),
          a.width > a.height
            ? r.set("LUT_STRIP_HORIZONTAL", "1")
            : n instanceof xi && r.set("LUT_3D", "1"),
          n instanceof xu)
        ) {
          const d = n.domainMin,
            f = n.domainMax;
          (d.x !== 0 ||
            ...
            f.y !== 1 ||
            f.z !== 1) &&
            (r.set("CUSTOM_INPUT_DOMAIN", "1"),
            (l.get("domainMin").value = d.clone()),
            (l.get("domainMax").value = f.clone()));
        }
      ...
      if (n !== null) {
        ...
        if (this.tetrahedralInterpolation && n instanceof xi)
          if (this.defines.has("CUSTOM_INPUT_DOMAIN")) {
            ...
            (l.setScalar(r - 1).divide(c),
              a.copy(n.domainMin).negate().multiply(l));
    ...
    configureTetrahedralInterpolation() {
      ...
      n !== null &&
        ...
        this.tetrahedralInterpolation &&
          (n instanceof xi
            ? ((n.minFilter = Jt), (n.magFilter = Jt))
            : console.warn("Tetrahedral interpolation requires a 3D texture")),
        n.source === void 0 && (n.needsUpdate = !0));
    }
  ...
  qh = `void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 noise=vec3(rand(uv*(1.0+time)));
#ifdef PREMULTIPLY
...
outputColor=vec4(noise,inputColor.a);
  ...
  Jh = class extends $t {
    constructor({ blendFunction: n = ie.SCREEN, premultiply: r = !1 } = {}) {
      (super("NoiseEffect", qh, { blendFunction: n }), (this.premultiply = r));
    }
    get premultiply() {
  ...
  $h = `#include <tonemapping_pars_fragment>
#if THREE_REVISION < 143
#define luminance(v) linearToRelativeLuminance(v)
#endif
  ...
  ep = class extends $t {
    constructor({
      ...
      (super("ToneMappingEffect", $h, {
        ...
        (this.luminancePass = new yu({
          renderTarget: this.renderTargetLuminance,
        })),
        (this.adaptiveLuminancePass = new Zd(this.luminancePass.texture, {
          minLuminance: g,
          adaptationRate: y,
        })),
    ...
    set mode(n) {
      if (this.mode !== n) {
        switch (
          (this.defines.clear(),
          this.defines.set("TONE_MAPPING_MODE", n.toFixed(0)),
          n)
        ) {
          case Bt.REINHARD:
            this.defines.set(
        ...
        ((this.adaptiveLuminancePass.enabled = n === Bt.REINHARD2_ADAPTIVE),
          this.setChanged());
      }
    }
    getMode() {
    ...
    set resolution(n) {
      const r = Math.max(0, Math.ceil(Math.log2(n))),
        l = Math.pow(2, r);
      (this.luminancePass.resolution.setPreferredSize(l, l),
        (this.adaptiveLuminanceMaterial.mipLevel1x1 = r));
    }
    getResolution() {
      return this.resolution;
    }
    ...
    update(n, r, l) {
      this.adaptiveLuminancePass.enabled &&
        (this.luminancePass.render(n, r),
        this.adaptiveLuminancePass.render(n, null, null, l));
    }
    initialize(n, r, l) {
      this.adaptiveLuminancePass.initialize(n, r, l);
    }
  },
  tp = `uniform float offset;uniform float darkness;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){const vec2 center=vec2(0.5);vec3 color=inputColor.rgb;
...
outputColor=vec4(color,inputColor.a);}`,
  np = class extends $t {
    constructor({
      ...
      super("VignetteEffect", tp, {
        blendFunction: n,
        defines: new Map([["VIGNETTE_TECHNIQUE", r.toFixed(0)]]),
        uniforms: new Map([
          ["offset", new Q(a)],
          ["darkness", new Q(c)],
        ]),
    ...
    set technique(n) {
      this.technique !== n &&
        (this.defines.set("VIGNETTE_TECHNIQUE", n.toFixed(0)),
        this.setChanged());
    }
    get eskil() {
  ...
  ig = class extends Yf {
    ...
    parse(n) {
      ...
      const p = Number(f[1]),
        y = new Float32Array(p ** 3 * 4),
        v = new Ne(0, 0, 0),
        h = new Ne(1, 1, 1);
      if (
        ((f = a.exec(n)),
        f !== null && v.set(Number(f[1]), Number(f[2]), Number(f[3])),
        (f = c.exec(n)),
        f !== null && h.set(Number(f[1]), Number(f[2]), Number(f[3])),
        v.x > h.x || v.y > h.y || v.z > h.z)
      )
        throw (
          v.set(0, 0, 0),
          h.set(1, 1, 1),
          new Error("Invalid input domain")
        );
      let S = 0;
      for (; (f = d.exec(n)) !== null; )
        ((y[S++] = Number(f[1])),
...
function rp(n) {
  ...
  const l = new Set(),
    a = (y, v) => {
      const h = typeof y == "function" ? y(r) : y;
      if (h !== r) {
        const S = r;
        ((r = v ? h : Object.assign({}, r, h)), l.forEach((x) => x(r, S)));
      }
    },
    c = () => r,
    d = (y, v = c, h = Object.is) => {
    ...
    p = {
      ...
      getState: c,
      subscribe: (y, v, h) =>
        v || h ? d(y, v, h) : (l.add(y), () => l.delete(y)),
      destroy: () => l.clear(),
    };
  return ((r = n(a, c, p)), p);
}
const ip =
  ...
  La = ip ? P.useEffect : P.useLayoutEffect;
function _u(n) {
  const r = typeof n == "function" ? rp(n) : n,
    l = (a = r.getState, c = Object.is) => {
      const [, d] = P.useReducer((I) => I + 1, 0),
        f = r.getState(),
        g = P.useRef(f),
        p = P.useRef(a),
        y = P.useRef(c),
        v = P.useRef(!1),
        h = P.useRef();
      h.current === void 0 && (h.current = a(f));
      let S,
        x = !1;
      ((g.current !== f || p.current !== a || y.current !== c || v.current) &&
        ((S = a(f)), (x = !c(h.current, S))),
        La(() => {
          (x && (h.current = S),
            (g.current = f),
            (p.current = a),
      ...
      La(() => {
        const I = () => {
            try {
              const T = r.getState(),
                D = p.current(T);
              y.current(h.current, D) ||
                ((g.current = T), (h.current = D), d());
            } catch {
              ((v.current = !0), d());
            }
          },
      ...
      (function (n) {
        ...
        function b(M, B) {
          ...
          try {
            for (
              D(B), h = l(p);
              h !== null && (!(h.expirationTime > B) || (M && !A()));
            ) {
              var W = h.callback;
              if (typeof W == "function") {
                ((h.callback = null), (S = h.priorityLevel));
                var K = W(h.expirationTime <= B);
                ((B = n.unstable_now()),
                  typeof K == "function"
                    ? (h.callback = K)
                    : h === l(p) && a(p),
            ...
            return (
              ...
              N > W
                ? ((M.sortIndex = N),
                  ...
                  l(p) === null &&
                    M === l(y) &&
                    (z ? (C(V), (V = -1)) : (z = !0), Ce(H, N - W)))
                : ((M.sortIndex = K), r(p, M), w || x || ((w = !0), ge(b))),
              M
            );
          }),
...
var Ia;
function lp() {
  return (Ia || ((Ia = 1), (Ks.exports = sp())), Ks.exports);
}
/**
 * @license React
 ...
 */ var op = function (r) {
  ...
  var Ee = Array.isArray,
    ...
    nc = r.getInstanceFromNode,
    rc = r.preparePortalMount,
    ic = r.getCurrentEventPriority,
    sc = r.detachDeletedInstance,
    lc = r.supportsMicrotasks,
    oc = r.scheduleMicrotask,
    bn = r.supportsTestSelectors,
    ac = r.findFiberRoot,
    uc = r.getBoundingRect,
    cc = r.getTextContent,
    Vn = r.isHiddenSubtree,
    fc = r.matchAccessibilityRole,
    dc = r.setFocusIfFocusable,
    hc = r.setupIntersectionObserver,
    pc = r.appendChild,
    vc = r.appendChildToContainer,
    mc = r.commitTextUpdate,
    gc = r.commitMount,
    yc = r.commitUpdate,
    Sc = r.insertBefore,
    xc = r.insertInContainerBefore,
    Ec = r.removeChild,
    _c = r.removeChildFromContainer,
    zl = r.resetTextContent,
    wc = r.hideInstance,
    Tc = r.hideTextInstance,
    Mc = r.unhideInstance,
    Rc = r.unhideTextInstance,
    Pc = r.clearContainer,
    Cc = r.cloneInstance,
    Al = r.createContainerChildSet,
    Bl = r.appendChildToContainerChildSet,
    Uc = r.finalizeContainerChildren,
    Nl = r.replaceContainerChildren,
    Ol = r.cloneHiddenInstance,
    kl = r.cloneHiddenTextInstance,
    Lc = r.canHydrateInstance,
    Dc = r.canHydrateTextInstance,
    Ic = r.canHydrateSuspenseInstance,
    Fl = r.isSuspenseInstancePending,
    zi = r.isSuspenseInstanceFallback,
    zc = r.registerSuspenseInstanceRetry,
    Wn = r.getNextHydratableSibling,
    Ac = r.getFirstHydratableChild,
    Bc = r.getFirstHydratableChildWithinContainer,
    Nc = r.getFirstHydratableChildWithinSuspenseInstance,
    Oc = r.hydrateInstance,
    kc = r.hydrateTextInstance,
    Fc = r.hydrateSuspenseInstance,
    Hc = r.getNextHydratableInstanceAfterSuspenseInstance,
    Hl = r.commitHydratedContainer,
    Gc = r.commitHydratedSuspenseInstance,
    jc = r.clearSuspenseBoundary,
    bc = r.clearSuspenseBoundaryFromContainer,
    Vc = r.shouldDeleteUnhydratedTailInstances,
    Wc = r.didNotMatchHydratedContainerTextInstance,
    Qc = r.didNotMatchHydratedTextInstance,
    Ai;
  function Qn(e) {
    if (Ai === void 0)
      try {
...
` + o[m].replace(" at new ", " at ");
  ...
  function jl(e, t, i) {
    ...
    if (((t = t.childContextTypes), typeof s.getChildContext != "function"))
      return i;
    s = s.getChildContext();
    for (var o in s) if (!(o in t)) throw Error(f(108, V(e) || "Unknown", o));
    return d({}, i, s);
  }
  function _r(e) {
    return (
  ...
  var vt = Math.clz32 ? Math.clz32 : Zc,
    Kc = Math.log,
    Yc = Math.LN2;
  function Zc(e) {
  ...
  var Gi = c.unstable_scheduleCallback,
    ...
    ef = c.unstable_shouldYield,
    tf = c.unstable_requestPaint,
    ze = c.unstable_now,
  ...
  var Et = typeof Object.is == "function" ? Object.is : lf,
    Ut = null,
    Pr = !1,
    Vi = !1;
  function Ql(e) {
  ...
  var af = g.ReactCurrentBatchConfig;
  function Cr(e, t) {
    if (Et(e, t)) return !0;
    if (
      typeof e != "object" ||
    ...
    for (s = 0; s < i.length; s++) {
      var o = i[s];
      if (!Xc.call(t, o) || !Et(e[o], t[o])) return !1;
    }
    return !0;
  }
  function uf(e) {
  ...
  function Xl(e, t, i) {
    hn
      ? (ye(Ur, t._currentValue), (t._currentValue = i))
      : (ye(Ur, t._currentValue2), (t._currentValue2 = i));
  }
  function Xi(e) {
    var t = Ur.current;
  ...
  function it(e) {
    ...
    if (Wi !== e)
      if (((e = { context: e, memoizedValue: t, next: null }), mn === null)) {
        ...
        ((mn = e), (Lr.dependencies = { lanes: 0, firstContext: e }));
      } else mn = mn.next = e;
    return t;
  }
  var wt = null,
  ...
  function Gt(e, t) {
    ...
    i !== null &&
      ((i = i.shared),
      Ue !== null && e.mode & 1 && !(oe & 2)
        ? ((e = i.interleaved),
          e === null
            ? ((t.next = t), wt === null ? (wt = [i]) : wt.push(i))
  ...
  function Ir(e, t, i, s) {
    ...
    if (E !== null) {
      ...
      j !== null &&
        ...
        (E = j.lastBaseUpdate),
        E !== m &&
          (E === null ? (j.firstBaseUpdate = O) : (E.next = O),
          (j.lastBaseUpdate = L)));
    }
    if (u !== null) {
      var ne = o.baseState;
      ...
      do {
        ...
        if ((s & $) === $) {
          ...
          e: {
            ...
            switch ((($ = t), (me = i), je.tag)) {
              ...
              case 0:
                if (
                  ((J = je.payload),
                  ($ = typeof J == "function" ? J.call(me, ne, $) : J),
                  $ == null)
                )
                  break e;
                ne = d({}, ne, $);
          ...
          ((me = {
            ...
            j === null ? ((O = j = me), (L = ne)) : (j = j.next = me),
            (m |= $));
        if (((E = E.next), E === null)) {
    ...
    if (((e = t.effects), (t.effects = null), e !== null))
      for (t = 0; t < e.length; t++) {
        var s = e[t],
          o = s.callback;
        if (o !== null) {
          if (((s.callback = null), (s = i), typeof o != "function"))
            throw Error(f(191, o));
          o.call(s);
        }
      }
  ...
  function $l(e, t, i) {
    ...
    return (
      typeof u == "object" && u !== null
        ? (u = it(u))
        : ((o = Xe(t) ? en : ke.current),
          (s = t.contextTypes),
          (u = (s = s != null) ? vn(e, o) : Ft)),
      (t = new t(i, u)),
      (e.memoizedState =
  ...
  function qi(e, t, i, s) {
    ...
    (typeof u == "object" && u !== null
      ? (o.context = it(u))
      : ((u = Xe(t) ? en : ke.current), (o.context = vn(e, u))),
      (o.state = e.memoizedState),
      (u = t.getDerivedStateFromProps),
      typeof u == "function" && (Zi(e, t, u, i), (o.state = e.memoizedState)),
      typeof t.getDerivedStateFromProps == "function" ||
        ...
        t !== o.state && zr.enqueueReplaceState(o, o.state, null),
        Ir(e, i, o, s),
        (o.state = e.memoizedState)),
  ...
  function $i(e) {
    for (; e === Ar; )
      ((Ar = yn[--Sn]), (yn[Sn] = null), (Br = yn[--Sn]), (yn[Sn] = null));
    for (; e === tn; )
      ((tn = st[--lt]),
        (st[lt] = null),
        (It = st[--lt]),
  ...
  function ro(e, t) {
    switch (e.tag) {
      case 5:
        return (
          (t = Lc(t, e.type, e.pendingProps)),
          t !== null ? ((e.stateNode = t), ($e = e), (et = Ac(t)), !0) : !1
        );
      case 6:
        return (
          (t = Dc(t, e.pendingProps)),
          t !== null ? ((e.stateNode = t), ($e = e), (et = null), !0) : !1
        );
      case 13:
        if (((t = Ic(t)), t !== null)) {
          var i = tn !== null ? { id: Dt, overflow: It } : null;
          return (
            (e.memoizedState = {
              dehydrated: t,
              treeContext: i,
  ...
  function Zn(e) {
    ...
    if (
      e.tag !== 3 &&
      (e.tag !== 5 || (Vc(e.type) && !ee(e.type, e.memoizedProps)))
    ) {
      var t = et;
      if (t) {
        if (es(e)) {
  ...
  function lo(e) {
    ...
    function E(R, _, U, G) {
      return _ === null || _.tag !== 6
        ? ((_ = Fs(U, R.mode, G)), (_.return = R), _)
        : ((_ = o(_, U)), (_.return = R), _);
    }
    function L(R, _, U, G) {
      var Z = U.type;
      return Z === v
        ? j(R, _, U.props.children, G, U.key)
        : _ !== null &&
            (_.elementType === Z ||
              (typeof Z == "object" &&
                Z !== null &&
                Z.$$typeof === D &&
                so(Z) === _.type))
          ? ((G = o(_, U.props)), (G.ref = qn(R, _, U)), (G.return = R), G)
          : ((G = hi(U.type, U.key, U.props, null, R.mode, G)),
            (G.ref = qn(R, _, U)),
            (G.return = R),
            G);
    }
    function O(R, _, U, G) {
      return _ === null ||
        ...
        ? ((_ = Hs(U, R.mode, G)), (_.return = R), _)
        : ((_ = o(_, U.children || [])), (_.return = R), _);
    }
    function j(R, _, U, G, Z) {
      return _ === null || _.tag !== 7
        ? ((_ = cn(U, R.mode, G, Z)), (_.return = R), _)
        : ((_ = o(_, U)), (_.return = R), _);
    }
    function ne(R, _, U) {
      if ((typeof _ == "string" && _ !== "") || typeof _ == "number")
        return ((_ = Fs("" + _, R.mode, U)), (_.return = R), _);
      if (typeof _ == "object" && _ !== null) {
        switch (_.$$typeof) {
          case p:
            return (
              (U = hi(_.type, _.key, _.props, null, R.mode, U)),
              (U.ref = qn(R, null, _)),
              (U.return = R),
              U
            );
        ...
        if (Ee(_) || X(_))
          return ((_ = cn(_, R.mode, U, null)), (_.return = R), _);
        Nr(R, _);
      }
      return null;
    }
    ...
    function me(R, _, U, G, Z) {
      if ((typeof G == "string" && G !== "") || typeof G == "number")
        return ((R = R.get(U) || null), E(_, R, "" + G, Z));
      if (typeof G == "object" && G !== null) {
        switch (G.$$typeof) {
          case p:
            return (
              (R = R.get(G.key === null ? U : G.key) || null),
              L(_, R, G, Z)
            );
          case y:
            return (
    ...
    function J(R, _, U, G) {
      for (
        var Z = null, le = null, re = _, fe = (_ = 0), Be = null;
        re !== null && fe < U.length;
        fe++
      ) {
        ...
        (e && re && de.alternate === null && t(R, re),
          (_ = u(de, _, fe)),
          le === null ? (Z = de) : (le.sibling = de),
          (le = de),
          (re = Be));
      }
      ...
      if (re === null) {
        for (; fe < U.length; fe++)
          ((re = ne(R, U[fe], G)),
            re !== null &&
              ((_ = u(re, _, fe)),
              le === null ? (Z = re) : (le.sibling = re),
              (le = re)));
        return (_e && nn(R, fe), Z);
      }
      for (re = s(R, re); fe < U.length; fe++)
        ((Be = me(re, R, fe, U[fe], G)),
          Be !== null &&
            (e &&
              Be.alternate !== null &&
              re.delete(Be.key === null ? fe : Be.key),
            (_ = u(Be, _, fe)),
            le === null ? (Z = Be) : (le.sibling = Be),
            (le = Be)));
      return (
        e &&
          re.forEach(function (Xt) {
            return t(R, Xt);
          }),
        _e && nn(R, fe),
        Z
    ...
    function je(R, _, U, G) {
      ...
      for (
        var le = (Z = null), re = _, fe = (_ = 0), Be = null, de = U.next();
        re !== null && !de.done;
        fe++, de = U.next()
      ) {
        re.index > fe ? ((Be = re), (re = null)) : (Be = re.sibling);
        ...
        (e && re && Xt.alternate === null && t(R, re),
          (_ = u(Xt, _, fe)),
          le === null ? (Z = Xt) : (le.sibling = Xt),
          (le = Xt),
          (re = Be));
      }
      if (de.done) return (i(R, re), _e && nn(R, fe), Z);
      if (re === null) {
        for (; !de.done; fe++, de = U.next())
          ((de = ne(R, de.value, G)),
            de !== null &&
              ((_ = u(de, _, fe)),
              le === null ? (Z = de) : (le.sibling = de),
      ...
      for (re = s(R, re); !de.done; fe++, de = U.next())
        ((de = me(re, R, fe, de.value, G)),
          de !== null &&
            (e &&
              de.alternate !== null &&
              re.delete(de.key === null ? fe : de.key),
            (_ = u(de, _, fe)),
            le === null ? (Z = de) : (le.sibling = de),
            (le = de)));
      return (
        e &&
          re.forEach(function (Ff) {
            return t(R, Ff);
          }),
        _e && nn(R, fe),
        Z
    ...
    function ft(R, _, U, G) {
        ...
        switch (U.$$typeof) {
          case p:
            e: {
              ...
              U.type === v
                ? ((_ = cn(U.props.children, R.mode, G, U.key)),
                  (_.return = R),
                  (R = _))
                : ((G = hi(U.type, U.key, U.props, null, R.mode, G)),
                  (G.ref = qn(R, _, U)),
          ...
          case y:
            e: {
              ...
              ((_ = Hs(U, R.mode, G)), (_.return = R), (R = _));
            }
            return m(R);
          case D:
      ...
      return (typeof U == "string" && U !== "") || typeof U == "number"
        ? ((U = "" + U),
          _ !== null && _.tag === 6
            ? (i(R, _.sibling), (_ = o(_, U)), (_.return = R), (R = _))
            : (i(R, _), (_ = Fs(U, R.mode, G)), (_.return = R), (R = _)),
          m(R))
        : i(R, _);
    }
    return ft;
  ...
  function Or(e) {
    for (var t = e; t !== null; ) {
      if (t.tag === 13) {
        ...
        if (i !== null && ((i = i.dehydrated), i === null || Fl(i) || zi(i)))
          return t;
  ...
  function as(e, t, i, s, o, u) {
    if (
      ...
      (t.updateQueue = null),
      (t.lanes = 0),
      (kr.current = e === null || e.memoizedState === null ? pf : vf),
      (e = i(s, o)),
      er)
    ) {
      u = 0;
  ...
  function Hr(e) {
    ...
    if (((e = i.interleaved), e !== null)) {
      o = e;
      do ((u = o.lane), (Me.lanes |= u), (Rn |= u), (o = o.next));
      while (o !== e);
  ...
  function co(e, t) {
    ...
    if (
      (u && ((s.memoizedState = o), (tt = !0)),
      (s = s.queue),
      rr(po.bind(null, i, s, e), [e]),
      s.getSnapshot !== t || u || (Ae !== null && Ae.memoizedState.tag & 1))
    ) {
      if (
        ((i.flags |= 2048),
        nr(9, ho.bind(null, i, s, o, t), void 0, null),
        Ue === null)
      )
        throw Error(f(349));
      Tn & 30 || fo(i, t, o);
  ...
  function cs(e) {
    ...
    return (
      ...
      (t.queue = e),
      (e = e.dispatch = hf.bind(null, Me, e)),
      [t.memoizedState, e]
    );
  }
  function nr(e, t, i, s) {
  ...
  function jr(e, t, i, s) {
    var o = zt();
    ((Me.flags |= e),
      (o.memoizedState = nr(1 | t, i, void 0, s === void 0 ? null : s)));
  }
  function br(e, t, i, s) {
    var o = Mt();
    s = s === void 0 ? null : s;
  ...
  function Ro(e, t, i) {
    Ue !== null && e.mode & 1 && !(oe & 2)
      ? ((e = t.interleaved),
        e === null
          ? ((i.next = i), wt === null ? (wt = [t]) : wt.push(t))
          : ((i.next = e.next), (e.next = i)),
        (t.interleaved = i))
      : ((e = t.pending),
  ...
  var Vr = {
    ...
    pf = {
      ...
      useImperativeHandle: function (e, t, i) {
        return (
          (i = i != null ? i.concat([e]) : null),
          jr(4194308, 4, So.bind(null, t, e), i)
        );
      },
      ...
      useReducer: function (e, t, i) {
        ...
        return (
          ...
          (s.queue = e),
          (e = e.dispatch = df.bind(null, Me, e)),
          [s.memoizedState, e]
        );
      },
      useRef: function (e) {
      ...
      useTransition: function () {
        var e = cs(!1),
          t = e[0];
        return ((e = ff.bind(null, e[1])), (zt().memoizedState = e), [t, e]);
      },
      ...
      useSyncExternalStore: function (e, t, i) {
        ...
        return (
          (o.queue = u),
          fs(po.bind(null, s, u, e), [e]),
          (s.flags |= 2048),
          nr(9, ho.bind(null, s, u, i, t), void 0, null),
          i
        );
      },
      useId: function () {
...
` +
  ...
  function Lo(e, t, i) {
    var s = e.pingCache;
    if (s === null) {
      s = e.pingCache = new gf();
      var o = new Set();
      s.set(t, o);
    } else ((o = s.get(t)), o === void 0 && ((o = new Set()), s.set(t, o)));
    o.has(i) || (o.add(i), (e = Df.bind(null, e, t, i)), t.then(e, e));
  }
  function Do(e) {
    do {
      var t;
  ...
  if (pt)
    ...
    ir = function (e, t, i, s) {
      for (var o = t.child; o !== null; ) {
        if (o.tag === 5) {
          ...
          ((u = o.stateNode),
            i && s && (u = kl(u, o.memoizedProps, o)),
            K(e, u));
        else if (o.tag !== 4) {
          if (o.tag === 22 && o.memoizedState !== null)
            ((u = o.child), u !== null && (u.return = o), ir(e, o, !0, !0));
    ...
    var Ao = function (e, t, i, s) {
      for (var o = t.child; o !== null; ) {
        if (o.tag === 5) {
          ...
          if (o.tag === 22 && o.memoizedState !== null)
            ((u = o.child), u !== null && (u.return = o), Ao(e, o, !0, !0));
          else if (o.child !== null) {
            ((o.child.return = o), (o = o.child));
            continue;
          }
    ...
    ((sr = function (e, t) {
      ...
      if (!zo(e, t)) {
        e = i.containerInfo;
        var s = Al(e);
        (Ao(s, t, !1, !1), (i.pendingChildren = s), Rt(t), Uc(e, s));
      }
    }),
      (Wr = function (e, t, i, s, o) {
        var u = e.stateNode,
        ...
        if ((e = zo(e, t)) && m === s) t.stateNode = u;
          ...
          var E = t.stateNode,
            L = Tt(ot.current),
            O = null;
          (m !== s && (O = ve(E, i, m, s, o, L)),
            e && O === null
              ? (t.stateNode = u)
              : ((u = Cc(u, O, i, m, s, t, e, E)),
                ue(u, i, s, o, L) && Rt(t),
                (t.stateNode = u),
                e ? Rt(t) : ir(u, t, !1, !1)));
        }
    ...
    switch (($i(t), t.tag)) {
          ...
          (e === null || e.child === null) &&
            (Zn(t)
              ...
              : e === null ||
                ...
                ((t.flags |= 1024), gt !== null && (Bs(gt), (gt = null)))),
          sr(e, t),
          Ge(t),
          null
        );
      case 5:
        ...
        if (e !== null && t.stateNode != null)
          ...
          if (((e = Tt(ot.current)), Zn(t))) {
            ...
            ((e = Oc(t.stateNode, t.type, t.memoizedProps, i, e, t, !Yn)),
              (t.updateQueue = e),
              e !== null && Rt(t));
          } else {
            var u = W(o, s, i, e, t);
        ...
        if (e && t.stateNode != null) Qr(e, t, e.memoizedProps, s);
          ...
          if (((e = Tt(_n.current)), (i = Tt(ot.current)), Zn(t))) {
            ...
            if (
              ((e = t.stateNode),
              (s = t.memoizedProps),
              (i = kc(e, s, t, !Yn)) && ((o = $e), o !== null))
            )
              switch (((u = (o.mode & 1) !== 0), o.tag)) {
                case 3:
                  Wc(o.stateNode.containerInfo, e, s, u);
                  break;
                case 5:
                  Qc(o.type, o.memoizedProps, o.stateNode, e, s, u);
              }
            i && Rt(t);
      ...
      case 13:
        if (
          (xe(Te),
          (s = t.memoizedState),
          _e && et !== null && t.mode & 1 && !(t.flags & 128))
        ) {
          for (e = et; e; ) e = Wn(e);
        ...
        return (
          gt !== null && (Bs(gt), (gt = null)),
          t.flags & 128
            ? ((t.lanes = i), t)
            : ((s = s !== null),
              (i = !1),
              e === null ? Zn(t) : (i = e.memoizedState !== null),
              s &&
                !i &&
                ((t.child.flags |= 8192),
                t.mode & 1 &&
                  (e === null || Te.current & 1 ? De === 0 && (De = 3) : Os())),
      ...
      case 19:
        ...
        if (((s = (t.flags & 128) !== 0), (u = o.rendering), u === null))
          if (s) lr(o, !1);
                ...
                if (((u = Or(e)), u !== null)) {
                  for (
                    t.flags |= 128,
                      lr(o, !1),
                      e = u.updateQueue,
                      e !== null && ((t.updateQueue = e), (t.flags |= 4)),
                      t.subtreeFlags = 0,
                      e = i,
                      s = t.child;
                    s !== null;
            ...
            o.tail !== null &&
              ze() > Ds &&
              ((t.flags |= 128), (s = !0), lr(o, !1), (t.lanes = 4194304));
          }
        else {
          if (!s)
            if (((e = Or(u)), e !== null)) {
      ...
      case 23:
        return (
          ...
          s && t.mode & 1
            ? nt & 1073741824 &&
              (Ge(t), pt && t.subtreeFlags & 6 && (t.flags |= 8192))
            : Ge(t),
          null
        );
      case 24:
    ...
    return (
      ...
      e !== null && !tt
        ? ((t.updateQueue = e.updateQueue),
          ...
          (e.lanes &= ~o),
          At(e, t, o))
        : (_e && i && Ji(t), (t.flags |= 1), Ve(e, t, s, o), t.child)
    );
  }
  function No(e, t, i, s, o) {
    if (e === null) {
      ...
      return typeof u == "function" &&
        ...
        ? ((t.tag = 15), (t.type = u), Oo(e, t, u, s, o))
        : ((e = hi(i.type, null, s, t, t.mode, o)),
          (e.ref = t.ref),
          (e.return = t),
          (t.child = e));
    }
    if (((u = e.child), !(e.lanes & o))) {
      ...
      if (
        ((i = i.compare), (i = i !== null ? i : Cr), i(m, s) && e.ref === t.ref)
      )
        return At(e, t, o);
    }
    return (
  ...
  function ko(e, t, i) {
    ...
    if (s.mode === "hidden")
      if (!(t.mode & 1))
        ...
        ((t.memoizedState = { baseLanes: 0, cachePool: null }),
          (s = u !== null ? u.baseLanes : i),
          ye(Mn, nt),
          (nt |= s));
      else
        return (
          (e = u !== null ? u.baseLanes | i : i),
      ...
      (u !== null ? ((s = u.baseLanes | i), (t.memoizedState = null)) : (s = i),
        ye(Mn, nt),
        (nt |= s));
    ...
    return (
      ...
      e !== null && !tt
        ? ((t.updateQueue = e.updateQueue),
          ...
          (e.lanes &= ~o),
          At(e, t, o))
        : (_e && s && Ji(t), (t.flags |= 1), Ve(e, t, i, o), t.child)
    );
  }
  function Ho(e, t, i, s, o) {
    ...
    if ((gn(t, o), t.stateNode === null))
      ...
      ((m.state = $),
        ...
        (L = t.memoizedState),
        E !== s || $ !== L || Qe.current || Ht
          ? (typeof j == "function" && (Zi(t, i, j, s), (L = t.memoizedState)),
            (E = Ht || Jl(t, i, E, s, $, L, O))
              ? (ne ||
      ...
      ((m = t.stateNode),
        Kl(e, t),
        (E = t.memoizedProps),
        (O = t.type === t.elementType ? E : mt(t.type, E)),
        (m.props = O),
        (ne = t.pendingProps),
        ($ = m.context),
        (L = i.contextType),
      ...
      E !== ne || $ !== J || Qe.current || Ht
        ? (typeof me == "function" && (Zi(t, i, me, s), (J = t.memoizedState)),
          (O = Ht || Jl(t, i, O, s, $, J, L) || !1)
            ? (j ||
                (typeof m.UNSAFE_componentWillUpdate != "function" &&
                  typeof m.componentWillUpdate != "function") ||
                (typeof m.componentWillUpdate == "function" &&
                  m.componentWillUpdate(s, J, L),
                typeof m.UNSAFE_componentWillUpdate == "function" &&
                  m.UNSAFE_componentWillUpdate(s, J, L)),
  ...
  function ms(e, t, i, s, o, u) {
    ...
    ((s = t.stateNode), (Sf.current = t));
    var E =
      m && typeof i.getDerivedStateFromError != "function" ? null : s.render();
    return (
      (t.flags |= 1),
      e !== null && m
        ? ((t.child = En(t, e.child, null, u)), (t.child = En(t, null, E, u)))
        : Ve(e, t, E, u),
  ...
  function Go(e) {
    var t = e.stateNode;
    (t.pendingContext
      ? Gl(e, t.pendingContext, t.pendingContext !== t.context)
      : t.context && Gl(e, t.context, !1),
  ...
  function bo(e, t, i) {
    ...
    if (
      ((E = m) ||
        (E = e !== null && e.memoizedState === null ? !1 : (o & 2) !== 0),
      E
        ? ((u = !0), (t.flags &= -129))
    ...
    if (((o = e.memoizedState), o !== null)) {
      if (((E = o.dehydrated), E !== null)) {
        if (m)
          return t.flags & 256
            ? ((t.flags &= -257), Yr(e, t, i, Error(f(422))))
            : t.memoizedState !== null
              ? ((t.child = e.child), (t.flags |= 128), null)
              : ((u = s.fallback),
                (o = t.mode),
                (s = pi({ mode: "visible", children: s.children }, o, 0, null)),
                (u = cn(u, o, i, null)),
                (u.flags |= 2),
                (s.return = t),
                (u.return = t),
        ...
        if (!(t.mode & 1)) t = Yr(e, t, i, null);
          ...
          if (((s = Ue), s !== null)) {
            ...
            ((s = u & (s.suspendedLanes | i) ? 0 : u),
              s !== 0 &&
                s !== o.retryLane &&
                ((o.retryLane = s), ut(e, s, -1)));
          }
            ...
            : ((i = o.treeContext),
              Je &&
                ...
                i !== null &&
                  ...
                  (It = i.overflow),
                  (tn = t))),
              (t = gs(t, t.pendingProps.children)),
              (t.flags |= 4096));
        return t;
      }
      return u
        ? ((s = Wo(e, t, s.children, s.fallback, i)),
          (u = t.child),
          (o = e.child.memoizedState),
          (u.memoizedState =
            o === null
              ? Kr(i)
              : { baseLanes: o.baseLanes | i, cachePool: null }),
          (u.childLanes = e.childLanes & ~i),
          (t.memoizedState = Xr),
          s)
        : ((i = Vo(e, t, s.children, i)), (t.memoizedState = null), i);
    }
    return u
      ? ((s = Wo(e, t, s.children, s.fallback, i)),
        (u = t.child),
        (o = e.child.memoizedState),
        (u.memoizedState =
          o === null ? Kr(i) : { baseLanes: o.baseLanes | i, cachePool: null }),
        (u.childLanes = e.childLanes & ~i),
        (t.memoizedState = Xr),
        s)
      : ((i = Vo(e, t, s.children, i)), (t.memoizedState = null), i);
  ...
  function Vo(e, t, i, s) {
    ...
    return (
      (e = o.sibling),
      (i = Qt(o, { mode: "visible", children: i })),
      !(t.mode & 1) && (i.lanes = s),
      (i.return = t),
      (i.sibling = null),
      e !== null &&
    ...
    return (
      !(u & 1) && t.child !== e
        ? ((i = t.child),
          ...
          (i.pendingProps = E),
          (t.deletions = null))
        : ((i = Qt(e, E)), (i.subtreeFlags = e.subtreeFlags & 14680064)),
      m !== null ? (s = Qt(m, s)) : ((s = cn(s, u, o, null)), (s.flags |= 2)),
      (s.return = t),
      (i.return = t),
      (i.sibling = s),
      (t.child = i),
  ...
  function Xo(e, t, i) {
    var s = t.pendingProps,
      o = s.revealOrder,
      u = s.tail;
    if ((Ve(e, t, s.children, i), (s = Te.current), s & 2))
      ((s = (s & 1) | 2), (t.flags |= 128));
    else {
  ...
  function At(e, t, i) {
    ...
    if (t.child !== null) {
      for (
        e = t.child, i = Qt(e, e.pendingProps), t.child = i, i.return = t;
        e.sibling !== null;
      )
        ((e = e.sibling),
          (i = i.sibling = Qt(e, e.pendingProps)),
          (i.return = t));
      i.sibling = null;
    }
    return t.child;
                ...
                case 1:
                  if (i !== null) {
                    var s = i.memoizedProps,
                      o = i.memoizedState,
                      u = e.stateNode,
                      m = u.getSnapshotBeforeUpdate(
                        e.elementType === e.type ? s : mt(e.type, s),
                        o,
                      );
                  ...
                  break;
                case 3:
                  pt && Pc(e.stateNode.containerInfo);
                  break;
                case 5:
                case 6:
                case 4:
    ...
    switch (t.tag) {
      ...
      case 4:
        pt
          ...
          : xr &&
            xr &&
            ((t = t.stateNode.containerInfo), (i = Al(t)), Nl(t, i));
    }
  }
  function Zo(e, t, i) {
    for (var s = t; ; )
  ...
  function Es(e, t, i) {
    var s = e.tag;
    if (s === 5 || s === 6) ((e = e.stateNode), t ? xc(i, e, t) : vc(i, e));
  ...
  function _s(e, t, i) {
    ...
    if (s === 5 || s === 6) ((e = e.stateNode), t ? Sc(i, e, t) : pc(i, e));
      ...
      for (_s(e, t, i), e = e.sibling; e !== null; )
        (_s(e, t, i), (e = e.sibling));
  }
  function ta(e, t, i) {
    for (var s = t, o = !1, u, m; ; ) {
      if (!o) {
      ...
      if (s.tag === 5 || s.tag === 6)
        (Zo(e, s, i), m ? _c(u, s.stateNode) : Ec(u, s.stateNode));
      else if (s.tag === 18) m ? bc(u, s.stateNode) : jc(u, s.stateNode);
      else if (s.tag === 4) {
        if (s.child !== null) {
      ...
      switch (t.tag) {
        ...
        case 5:
          ...
          if (i != null) {
            ...
            var o = t.type,
              u = t.updateQueue;
            ((t.updateQueue = null), u !== null && yc(i, u, o, e, s, t));
          }
          return;
        case 6:
          if (t.stateNode === null) throw Error(f(162));
          ((i = t.memoizedProps),
            mc(t.stateNode, e !== null ? e.memoizedProps : i, i));
          return;
        case 3:
          Je &&
            e !== null &&
            e.memoizedState.isDehydrated &&
            Hl(t.stateNode.containerInfo);
          return;
        case 12:
          return;
        case 13:
  ...
  function Jr(e) {
    ...
    if (t !== null) {
      e.updateQueue = null;
      var i = e.stateNode;
      (i === null && (i = e.stateNode = new _f()),
        t.forEach(function (s) {
          var o = zf.bind(null, e, s);
  ...
  function Tf(e, t) {
    for (F = t; F !== null; ) {
      ...
      if (((i = t.child), t.subtreeFlags & 12854 && i !== null))
        ((i.return = t), (F = i));
      else
        for (; F !== null; ) {
          t = F;
                      ...
                      for (var J = s; ; ) {
                        if (J.tag === 5) {
                          if (u === null) {
                            u = J;
                            var je = J.stateNode;
                            o ? wc(je) : Mc(J.stateNode, J.memoizedProps);
                          }
                        } else if (J.tag === 6) {
                          if (u === null) {
                            var ft = J.stateNode;
                            o ? Tc(ft) : Rc(ft, J.memoizedProps);
                          }
                        } else if (
                          ((J.tag !== 22 && J.tag !== 23) ||
  ...
  function na(e, t, i) {
    for (var s = (e.mode & 1) !== 0; F !== null; ) {
      ...
      if (o.tag === 22 && s) {
        ...
        o.subtreeFlags & 8772 && u !== null ? ((u.return = o), (F = u)) : ra(e);
    }
  }
  function ra(e) {
    for (; F !== null; ) {
        ...
        try {
          if (t.flags & 8772)
            switch (t.tag) {
              ...
              case 5:
                var E = t.stateNode;
                i === null && t.flags & 4 && gc(E, t.type, t.memoizedProps, t);
                break;
              case 6:
                break;
              case 4:
  ...
  if (typeof Symbol == "function" && Symbol.for) {
    var ar = Symbol.for;
    (($r = ar("selector.component")),
      (ei = ar("selector.has_pseudo_class")),
      (ti = ar("selector.role")),
      (ni = ar("selector.test_id")),
      (ri = ar("selector.text")));
  }
  function Ts(e) {
    var t = nc(e);
    ...
    if (((e = ac(e)), e === null)) throw Error(f(362));
  ...
  function Ms(e, t) {
    switch (t.$$typeof) {
      ...
      case ei:
        ...
        return t;
      case ti:
        if (e.tag === 5 && fc(e.stateNode, t.value)) return !0;
        break;
      case ri:
        if (
          (e.tag === 5 || e.tag === 6) &&
          ((e = cc(e)), e !== null && 0 <= e.indexOf(t.value))
        )
          return !0;
        break;
      case ni:
  ...
  function la(e, t) {
    ...
    for (var s = 0; s < e.length; ) {
      ...
      if (o.tag !== 5 || !Vn(o)) {
        ...
        else for (o = o.child; o !== null; ) (e.push(o, u), (o = o.sibling));
      }
    }
    return i;
  }
  function Ps(e, t) {
    ...
    for (var i = 0; i < e.length; ) {
      ...
      else for (s = s.child; s !== null; ) (e.push(s), (s = s.sibling));
    }
    return t;
  }
  var Rf = Math.ceil,
  ...
  function Vt(e) {
    return e.mode & 1
      ? oe & 2 && Oe !== 0
        ...
        : af.transition !== null
          ? (ci === 0 &&
              ((e = wr), (wr <<= 1), !(wr & 4194240) && (wr = 64), (ci = e)),
            ci)
          : ((e = ce), e !== 0 ? e : ic())
      : 1;
  }
  function ut(e, t, i) {
    ...
    return s === null
      ...
      : (Kn(s, t, i),
        (!(oe & 2) || s !== Ue) &&
          (s === Ue && (!(oe & 2) && (si |= t), De === 4 && Wt(s, Oe)),
          Ye(s, i),
          t === 1 && oe === 0 && !(e.mode & 1) && (Pn(), Pr && _t())),
        s);
  }
  function fi(e, t) {
    e.lanes |= t;
  ...
  function Ye(e, t) {
    ...
    if (s === 0)
      (i !== null && Wl(i), (e.callbackNode = null), (e.callbackPriority = 0));
    else if (((t = s & -s), e.callbackPriority !== t)) {
      if ((i != null && Wl(i), t === 1))
        (e.tag === 0 ? of(aa.bind(null, e)) : Ql(aa.bind(null, e)),
          lc
            ? oc(function () {
                oe === 0 && _t();
              })
  ...
  function oa(e, t) {
    ...
    if (s & 30 || s & e.expiredLanes || t) t = di(e, s);
      ...
      (Qi(),
        (ii.current = u),
        (oe = o),
        Le !== null ? (t = 0) : ((Ue = null), (Oe = 0), (t = De)));
    }
    if (t !== 0) {
      if (
        (t === 2 && ((o = ki(e)), o !== 0 && ((s = o), (t = As(e, o)))),
        t === 1)
      )
        throw ((i = ur), on(e, 0), Wt(e, s), Ye(e, ze()), i);
      if (t === 6) Wt(e, s);
      else {
        if (
        ...
        switch (((e.finishedWork = o), (e.finishedLanes = s), t)) {
          ...
          case 3:
            if (
              (Wt(e, s),
              (s & 130023424) === s && ((t = Ls + 500 - ze()), 10 < t))
            ) {
              if (Mr(e, 0) !== 0) break;
  ...
  function Os() {
    ((De === 0 || De === 3 || De === 2) && (De = 4),
      Ue === null || (!(Rn & 268435455) && !(si & 268435455)) || Wt(Ue, Oe));
  }
  function di(e, t) {
    var i = oe;
    oe |= 2;
  ...
  function an(e, t) {
    var i = ce,
      s = Pe.transition;
    try {
      ((Pe.transition = null), (ce = 1), Lf(e, t, i));
    } finally {
  ...
  function un() {
    if (bt !== null) {
      var e = Vl(ai),
        ...
        i = ce;
      try {
        if (((Pe.transition = null), (ce = 16 > e ? 16 : e), bt === null))
          var s = !1;
        else {
  ...
  function Df(e, t, i) {
    ...
    (s !== null && s.delete(t),
      ...
      Ue === e &&
        (Oe & i) === i &&
        (De === 4 || (De === 3 && (Oe & 130023424) === Oe && 500 > ze() - Ls)
          ? on(e, 0)
          : (Us |= i)),
      Ye(e, t));
  }
  ...
  ma = function (e, t, i) {
    if (e !== null)
      if (e.memoizedProps !== t.pendingProps || Qe.current) tt = !0;
        ...
        if (!(e.lanes & i) && !(t.flags & 128)) return ((tt = !1), xf(e, t, i));
        tt = !!(e.flags & 131072);
      }
    ...
    switch (((t.lanes = 0), t.tag)) {
        ...
        return (
          ...
          o.$$typeof === void 0
            ? ((t.tag = 1),
              ...
              qi(t, s, e, i),
              (t = ms(null, t, s, !0, u, i)))
            : ((t.tag = 0), _e && u && Ji(t), Ve(null, t, o, i), (t = t.child)),
          t
        );
      case 16:
        s = t.elementType;
      ...
      case 3:
        e: {
          if ((Go(t), e === null)) throw Error(f(387));
          ((s = t.pendingProps),
            (u = t.memoizedState),
            (o = u.element),
            Kl(e, t),
          ...
          if (((s = m.element), Je && u.isDehydrated))
            if (
              ...
              for (
                Je &&
                  ((et = Bc(t.stateNode.containerInfo)),
                  ($e = t),
                  (_e = !0),
                  (gt = null),
                  (Yn = !1)),
      ...
      case 5:
        return (
          ...
          (m = o.children),
          ee(s, o) ? (m = null) : u !== null && ee(s, u) && (t.flags |= 32),
          Fo(e, t),
          Ve(e, t, m, i),
          t.child
        );
      ...
      case 4:
        return (
          rs(t, t.stateNode.containerInfo),
          (s = t.pendingProps),
          e === null ? (t.child = En(t, null, s, i)) : Ve(e, t, s, i),
          t.child
        );
      case 11:
        return (
  ...
  function Nf(e, t, i, s, o) {
    ((this.tag = t),
      ...
      Je && (this.mutableSourceEagerHydrationData = null));
  }
  ...
  return (
    ...
    (l.findBoundingRects = function (e, t) {
      if (!bn) throw Error(f(363));
      ((t = Ps(e, t)), (e = []));
      for (var i = 0; i < t.length; i++) e.push(uc(t[i]));
      for (t = e.length - 1; 0 < t; t--) {
        i = e[t];
        for (
          var s = i.x, o = s + i.width, u = i.y, m = u + i.height, E = t - 1;
          0 <= E;
          E--
        )
          if (t !== E) {
            ...
            if (s >= O && u >= ne && o <= j && m <= $) {
              ...
              if (!(u !== ne || i.height !== L.height || j < s || O > o)) {
                (O > s && ((L.width += O - s), (L.x = s)),
                  j < o && (L.width = o - O),
                  e.splice(t, 1));
                break;
              }
            } else {
              (ne > u && ((L.height += ne - u), (L.y = u)),
                $ < m && (L.height = m - ne),
                e.splice(t, 1));
              break;
            }
    ...
    (l.focusWithin = function (e, t) {
      ...
      for (e = Ts(e), t = la(e, t), t = Array.from(t), e = 0; e < t.length; ) {
        var i = t[e++];
        if (!Vn(i)) {
          if (i.tag === 5 && dc(i.stateNode)) return !0;
    ...
    (l.getFindAllNodesFailureDescription = function (e, t) {
      ...
      for (var o = 0; o < e.length; ) {
        ...
        if (
          (u.tag !== 5 || !Vn(u)) &&
          (Ms(u, E) && (s.push(Rs(E)), m++, m > i && (i = m)), m < t.length)
        )
    ...
    (l.injectIntoDevTools = function (e) {
      if (
        ((e = {
          ...
          findHostInstanceByFiber: Of,
          findFiberByHostInstance: e.findFiberByHostInstance || kf,
    ...
    try {
      for (
        ...
        if (typeof W == "function") {
          ...
          var K = W(h.expirationTime <= B);
          ((B = n.unstable_now()),
            typeof K == "function" ? (h.callback = K) : h === l(p) && a(p),
            D(B));
        } else a(p);
        h = l(p);
      }
...
var za = Tu.exports;
const xl = {},
  Ru = (n) => void Object.assign(xl, n);
function cp(n, r) {
  function l(v, { args: h = [], attach: S, ...x }, w) {
    ...
    if (v === "primitive") {
      ...
      const C = x.object;
      I = Ln(C, { type: v, root: w, attach: S, primitive: !0 });
    } else {
      const C = xl[z];
      if (!C)
        throw new Error(
          `R3F: ${z} is not part of the THREE namespace! Did you forget to extend? See: https://docs.pmnd.rs/react-three-fiber/api/objects#using-3rd-party-objects-declaratively`,
        );
      if (!Array.isArray(h))
    ...
    return (
      I.__r3f.attach === void 0 &&
        (I instanceof ml
          ? (I.__r3f.attach = "geometry")
          : I instanceof fl && (I.__r3f.attach = "material")),
      z !== "inject" && Js(I, x),
      I
    );
  }
  function a(v, h) {
    ...
    if (h) {
      ...
      ((x = h.__r3f) != null && x.attach
        ? qs(v, h, h.__r3f.attach)
        : h.isObject3D && v.isObject3D && (v.add(h), (S = !0)),
        S || (w = v.__r3f) == null || w.objects.push(h),
        h.__r3f || Ln(h, {}),
        (h.__r3f.parent = v),
        ol(h),
        Dn(h));
  ...
  function c(v, h, S) {
    ...
    if (h) {
      var w, z;
      if ((w = h.__r3f) != null && w.attach) qs(v, h, h.__r3f.attach);
      else if (h.isObject3D && v.isObject3D) {
        ((h.parent = v), h.dispatchEvent({ type: "added" }));
        const I = v.children.filter((T) => T !== h),
          C = I.indexOf(S);
        ((v.children = [...I.slice(0, C), h, ...I.slice(C)]), (x = !0));
      }
      (x || (z = v.__r3f) == null || z.objects.push(h),
        h.__r3f || Ln(h, {}),
        (h.__r3f.parent = v),
        ol(h),
        Dn(h));
  ...
  function f(v, h, S) {
    if (h) {
      ...
      if (
        ...
        (x = v.__r3f) != null &&
          x.objects &&
          (v.__r3f.objects = v.__r3f.objects.filter((H) => H !== h)),
        (w = h.__r3f) != null && w.attach)
      )
        ka(v, h, h.__r3f.attach);
      else if (h.isObject3D && v.isObject3D) {
        var I;
        (v.remove(h), (I = h.__r3f) != null && I.root && gp(h.__r3f.root, h));
      }
      const T = (z = h.__r3f) == null ? void 0 : z.primitive,
        D = !T && (S === void 0 ? h.dispose !== null : S);
      if (!T) {
        var C;
        (d((C = h.__r3f) == null ? void 0 : C.objects, h, D),
          d(h.children, h, D));
      }
      if ((delete h.__r3f, D && h.dispose && h.type !== "Scene")) {
        const H = () => {
          try {
            h.dispose();
          } catch {}
        ...
        typeof IS_REACT_ACT_ENVIRONMENT > "u"
          ? za.unstable_scheduleCallback(za.unstable_IdlePriority, H)
          : H();
      }
      Dn(v);
    }
  ...
  function g(v, h, S, x) {
    ...
    if (!z) return;
    const I = l(h, S, v.__r3f.root);
    if (v.children) {
      for (const C of v.children) C.__r3f && a(I, C);
      v.children = v.children.filter((C) => !C.__r3f);
    }
    (v.__r3f.objects.forEach((C) => a(I, C)),
      (v.__r3f.objects = []),
      v.__r3f.autoRemovedBeforeAppend || f(z, v),
      I.parent && (I.__r3f.autoRemovedBeforeAppend = !0),
      a(z, I),
      I.raycast &&
        I.__r3f.eventCount &&
        I.__r3f.root.getState().internal.interaction.push(I),
      [x, x.alternate].forEach((C) => {
        C !== null &&
          ((C.stateNode = I),
          C.ref &&
            (typeof C.ref == "function" ? C.ref(I) : (C.ref.current = I)));
      }));
  }
  const p = () =>
    console.warn(
  ...
  return {
    reconciler: up({
      ...
      supportsHydration: !1,
      noTimeout: -1,
      appendChildToContainer: (v, h) => {
        if (!h) return;
        const S = v.getState().scene;
        S.__r3f && ((S.__r3f.root = v), a(S, h));
      },
      removeChildFromContainer: (v, h) => {
        h && f(v.getState().scene, h);
      },
      insertInContainerBefore: (v, h, S) => {
        if (!h || !S) return;
      ...
      finalizeInitialChildren(v) {
        var h;
        return !!((h = v == null ? void 0 : v.__r3f) != null ? h : {}).handlers;
      },
      prepareUpdate(v, h, S, x) {
        var w;
        if (
          ((w = v == null ? void 0 : v.__r3f) != null ? w : {}).primitive &&
          x.object &&
          x.object !== v
        )
          return [!0];
        {
          const { args: I = [], children: C, ...T } = x,
            { args: D = [], children: H, ...b } = S;
          if (!Array.isArray(I))
            throw new Error("R3F: the args prop must be an array!");
      ...
      commitMount(v, h, S, x) {
        ...
        v.raycast &&
          z.handlers &&
          z.eventCount &&
          v.__r3f.root.getState().internal.interaction.push(v);
      },
      ...
      hideInstance(v) {
        var h;
        const { attach: S, parent: x } = (h = v.__r3f) != null ? h : {};
        (S && x && ka(x, v, S), v.isObject3D && (v.visible = !1), Dn(v));
      },
      unhideInstance(v, h) {
        var S;
        const { attach: x, parent: w } = (S = v.__r3f) != null ? S : {};
        (x && w && qs(w, v, x),
          ((v.isObject3D && h.visible == null) || h.visible) &&
            (v.visible = !0),
          Dn(v));
      },
      ...
      now:
        typeof performance < "u" && we.fun(performance.now)
          ? performance.now
          : we.fun(Date.now)
            ? Date.now
            : () => 0,
...
const Zs = (n) => "colorSpace" in n || "outputColorSpace" in n,
  ...
  Cu = (n) => n && n.isOrthographicCamera,
  fp = (n) => n && n.hasOwnProperty("current"),
  kn =
    typeof window < "u" &&
    (((Aa = window.document) != null && Aa.createElement) ||
      ((Ba = window.navigator) == null ? void 0 : Ba.product) === "ReactNative")
      ? P.useLayoutEffect
      : P.useEffect;
function Uu(n) {
  const r = P.useRef(n);
...
class Lu extends P.Component {
  constructor(...r) {
    (super(...r), (this.state = { error: !1 }));
  }
  componentDidCatch(r) {
    this.props.set(r);
  }
...
Lu.getDerivedStateFromError = () => ({ error: !0 });
const Du = "__default",
  Na = new Map(),
  hp = (n) => n && !!n.memoized && !!n.changes;
function Iu(n) {
  var r;
  const l =
    typeof window < "u" ? ((r = window.devicePixelRatio) != null ? r : 2) : 1;
...
const dr = (n) => {
  ...
  we = {
    ...
    equ(
      n,
      r,
      { arrays: l = "shallow", objects: a = "reference", strict: c = !0 } = {},
    ) {
      ...
      if ((f || d) && n === r) return !0;
      let g;
      for (g in n) if (!(g in r)) return !1;
      if (d && l === "shallow" && a === "shallow") {
        for (g in c ? r : n)
          if (!we.equ(n[g], r[g], { strict: c, objects: "reference" }))
            return !1;
      } else for (g in c ? r : n) if (n[g] !== r[g]) return !1;
      if (we.und(g)) {
        if (
          (f && n.length === 0 && r.length === 0) ||
          (d && Object.keys(n).length === 0 && Object.keys(r).length === 0)
        )
          return !0;
        if (n !== r) return !1;
      }
...
function ll(n, r) {
  ...
  if (r.includes("-")) {
    const a = r.split("-"),
      c = a.pop();
    return ((l = a.reduce((d, f) => d[f], n)), { target: l, key: c });
  } else return { target: l, key: r };
}
const Oa = /-\d+$/;
function qs(n, r, l) {
  if (we.str(l)) {
    if (Oa.test(l)) {
      const d = l.replace(Oa, ""),
        { target: f, key: g } = ll(n, d);
      Array.isArray(f[g]) || (f[g] = []);
    }
    const { target: a, key: c } = ll(n, l);
...
function ka(n, r, l) {
  var a, c;
  if (we.str(l)) {
    const { target: d, key: f } = ll(n, l),
      g = r.__r3f.previousAttach;
    g === void 0 ? delete d[f] : (d[f] = g);
  } else
    (a = r.__r3f) == null || a.previousAttach == null || a.previousAttach(n, r);
  (c = r.__r3f) == null || delete c.previousAttach;
}
function zu(
  n,
  { children: r, key: l, ref: a, ...c },
  { children: d, key: f, ref: g, ...p } = {},
  y = !1,
) {
  var v;
  const h = (v = n == null ? void 0 : n.__r3f) != null ? v : {},
    S = Object.entries(c),
    x = [];
  if (y) {
    const z = Object.keys(p);
    for (let I = 0; I < z.length; I++)
      c.hasOwnProperty(z[I]) || S.unshift([z[I], Du + "remove"]);
  }
  S.forEach(([z, I]) => {
    var C;
    if (
      ((C = n.__r3f) != null && C.primitive && z === "object") ||
      we.equ(I, p[z])
    )
      return;
    if (/^on(Pointer|Click|DoubleClick|ContextMenu|Wheel)/.test(z))
      return x.push([z, I, !0, []]);
    let T = [];
  ...
  const w = { ...c };
  return (
    h.memoizedProps && h.memoizedProps.args && (w.args = h.memoizedProps.args),
    h.memoizedProps &&
      h.memoizedProps.attach &&
      (w.attach = h.memoizedProps.attach),
    { memoized: w, changes: x }
  );
}
const vp = typeof process < "u" && !1;
function Js(n, r) {
  var l, a, c;
  const d = (l = n.__r3f) != null ? l : {},
    f = d.root,
    g =
      (a = f == null || f.getState == null ? void 0 : f.getState()) != null
        ? a
        : {},
    { memoized: p, changes: y } = hp(r) ? r : zu(n, r),
    v = d.eventCount;
  n.__r3f && (n.__r3f.memoizedProps = p);
  for (let S = 0; S < y.length; S++) {
    ...
    if (Zs(n)) {
      const H = "srgb",
        b = "srgb-linear";
      x === "encoding"
        ? ((x = "colorSpace"), (w = w === 3001 ? H : b))
        : x === "outputEncoding" &&
          ((x = "outputColorSpace"), (w = w === 3001 ? H : b));
    }
    let C = n,
      T = C[x];
    ...
    if (w === Du + "remove")
      if (C.constructor) {
        ...
        (D || ((D = new C.constructor()), Na.set(C.constructor, D)),
          (w = D[x]));
      } else w = 0;
    if (z)
      (w ? (d.handlers[x] = w) : delete d.handlers[x],
      ...
      if (Array.isArray(w)) T.fromArray ? T.fromArray(w) : T.set(...w);
        ...
        w.constructor &&
        (vp
          ? T.constructor.name === w.constructor.name
          : T.constructor === w.constructor)
      )
        T.copy(w);
      else if (w !== void 0) {
        ...
        (!D && T.setScalar
          ? T.setScalar(w)
          : T instanceof bs && w instanceof bs
            ? (T.mask = w.mask)
            : T.set(w),
          !Pu() && !g.linear && D && T.convertSRGBToLinear());
      }
    } else if (
      ((C[x] = w), C[x] instanceof dl && C[x].format === Ei && C[x].type === Ct)
    ) {
      const D = C[x];
      Zs(D) && Zs(g.gl)
        ? (D.colorSpace = g.gl.outputColorSpace)
        : (D.encoding = g.gl.outputEncoding);
    }
    Dn(n);
  }
  if (d.parent && g.internal && n.raycast && v !== d.eventCount) {
    const S = g.internal.interaction.indexOf(n);
    (S > -1 && g.internal.interaction.splice(S, 1),
      d.eventCount && g.internal.interaction.push(n));
  }
  return (
...
function Dn(n) {
  var r, l;
  const a =
    (r = n.__r3f) == null || (l = r.root) == null || l.getState == null
      ? void 0
      : l.getState();
...
function Bu(n, r, l, a) {
  ...
  c &&
    (l.delete(r),
    l.size === 0 && (n.delete(a), c.target.releasePointerCapture(a)));
}
function gp(n, r) {
  const { internal: l } = n.getState();
  ((l.interaction = l.interaction.filter((a) => a !== r)),
    (l.initialHits = l.initialHits.filter((a) => a !== r)),
    l.hovered.forEach((a, c) => {
      (a.eventObject === r || a.object === r) && l.hovered.delete(c);
    }),
    l.capturedMap.forEach((a, c) => {
      Bu(l.capturedMap, r, a, c);
    }));
}
function yp(n) {
  function r(p) {
    const { internal: y } = n.getState(),
      v = p.offsetX - y.initialClick[0],
      h = p.offsetY - y.initialClick[1];
    return Math.round(Math.sqrt(v * v + h * h));
  }
  function l(p) {
    return p.filter((y) =>
      ["Move", "Over", "Enter", "Out", "Leave"].some((v) => {
        var h;
        return (h = y.__r3f) == null ? void 0 : h.handlers["onPointer" + v];
      }),
    );
  }
  function a(p, y) {
      ...
      if (T.raycaster.camera === void 0) {
        ...
        (T.events.compute == null ||
          T.events.compute(
            p,
            T,
            (D = T.previousRoot) == null ? void 0 : D.getState(),
          ),
    ...
    let z = x
      ...
      .sort((C, T) => {
        ...
        return !D || !H
          ...
          : H.events.priority - D.events.priority || C.distance - T.distance;
      })
      .filter((C) => {
        const T = yi(C);
        return h.has(T) ? !1 : (h.add(T), !0);
      });
    ...
    for (const C of z) {
      ...
      for (; T; ) {
        ...
        ((I = T.__r3f) != null &&
          I.eventCount &&
          S.push({ ...C, eventObject: T }),
          (T = T.parent));
      }
    }
    if ("pointerId" in p && v.internal.capturedMap.has(p.pointerId))
      for (let C of v.internal.capturedMap.get(p.pointerId).values())
        h.has(yi(C.intersection)) || S.push(C.intersection);
    return S;
  }
  function c(p, y, v, h) {
    const S = n.getState();
    if (p.length) {
      ...
      for (const w of p) {
        const z = dr(w.object) || S,
          { raycaster: I, pointer: C, camera: T, internal: D } = z,
          H = new Ne(C.x, C.y, 0).unproject(T),
          b = (k) => {
            var A, Y;
            return (A =
              (Y = D.capturedMap.get(k)) == null
                ? void 0
                : Y.has(w.eventObject)) != null
              ? A
              : !1;
          },
          X = (k) => {
            const A = { intersection: w, target: y.target };
            (D.capturedMap.has(k)
              ? D.capturedMap.get(k).set(w.eventObject, A)
              : D.capturedMap.set(k, new Map([[w.eventObject, A]])),
              y.target.setPointerCapture(k));
          },
          te = (k) => {
            const A = D.capturedMap.get(k);
            A && Bu(D.capturedMap, w.eventObject, A, k);
          };
        let V = {};
        for (let k in y) {
          let A = y[k];
        ...
        let q = {
          ...
          stopPropagation() {
            ...
            if (
              (!k || k.has(w.eventObject)) &&
              ((q.stopped = x.stopped = !0),
              D.hovered.size &&
                Array.from(D.hovered.values()).find(
                  (A) => A.eventObject === w.eventObject,
                ))
            ) {
              const A = p.slice(0, p.indexOf(w));
              d([...A, w]);
            }
          },
          target: {
      ...
      if (
        ...
        !p.find(
          (h) =>
            h.object === v.object &&
            h.index === v.index &&
            h.instanceId === v.instanceId,
        )
      ) {
        const S = v.eventObject.__r3f,
          x = S == null ? void 0 : S.handlers;
        if ((y.hovered.delete(yi(v)), S != null && S.eventCount)) {
          const w = { ...v, intersections: p };
          (x.onPointerOut == null || x.onPointerOut(w),
            x.onPointerLeave == null || x.onPointerLeave(w));
        }
      }
  }
  function f(p, y) {
  ...
  function g(p) {
    switch (p) {
      ...
      case "onLostPointerCapture":
        return (y) => {
          const { internal: v } = n.getState();
          "pointerId" in y &&
            v.capturedMap.has(y.pointerId) &&
            requestAnimationFrame(() => {
              v.capturedMap.has(y.pointerId) &&
                (v.capturedMap.delete(y.pointerId), d([]));
            });
        };
    }
    return function (v) {
      const { onPointerMissed: h, internal: S } = n.getState();
      S.lastEvent.current = v;
      const x = p === "onPointerMove",
        w = p === "onClick" || p === "onContextMenu" || p === "onDoubleClick",
        I = a(v, x ? l : void 0),
        C = w ? r(v) : 0;
      (p === "onPointerDown" &&
        ((S.initialClick = [v.offsetX, v.offsetY]),
        (S.initialHits = I.map((D) => D.eventObject))),
        w && !I.length && C <= 2 && (f(v, S.interaction), h && h(v)),
        x && d(I));
      function T(D) {
          ...
          if (x) {
            if (
              ...
              const te = yi(D),
                V = S.hovered.get(te);
              V
                ? V.stopped && D.stopPropagation()
                : (S.hovered.set(te, D),
                  X.onPointerOver == null || X.onPointerOver(D),
                  X.onPointerEnter == null || X.onPointerEnter(D));
            }
            X.onPointerMove == null || X.onPointerMove(D);
          } else {
            const te = X[p];
            te
              ? (!w || S.initialHits.includes(H)) &&
                (f(
                  v,
                  S.interaction.filter((V) => !S.initialHits.includes(V)),
                ),
                te(D))
              : w &&
                S.initialHits.includes(H) &&
                f(
                  v,
                  S.interaction.filter((V) => !S.initialHits.includes(V)),
                );
  ...
  xp = (n, r) => {
    const l = _u((g, p) => {
        const y = new Ne(),
          v = new Ne(),
          h = new Ne();
        function S(C = p().camera, T = v, D = p().size) {
          const { width: H, height: b, top: X, left: te } = D,
            V = H / b;
          T instanceof Ne ? h.copy(T) : h.set(...T);
          const q = C.getWorldPosition(y).distanceTo(h);
          if (Cu(C))
            return {
              width: H / C.zoom,
              height: b / C.zoom,
        ...
        let x;
        const w = (C) =>
            g((T) => ({ performance: { ...T.performance, current: C } })),
          z = new Se();
        return {
          set: g,
          get: p,
          ...
          performance: {
            ...
            regress: () => {
              const C = p();
              (x && clearTimeout(x),
                C.performance.current !== C.performance.min &&
                  w(C.performance.min),
                (x = setTimeout(
                  () => w(p().performance.max),
                  C.performance.debounce,
                )));
            },
          },
          ...
          setEvents: (C) => g((T) => ({ ...T, events: { ...T.events, ...C } })),
          setSize: (C, T, D, H, b) => {
            const X = p().camera,
              te = {
                width: C,
          ...
          setFrameloop: (C = "always") => {
            ...
            (T.stop(),
              (T.elapsedTime = 0),
              C !== "never" && (T.start(), (T.elapsedTime = 0)),
              g(() => ({ frameloop: C })));
          },
          previousRoot: void 0,
          internal: {
            ...
            subscribe: (C, T, D) => {
              const H = p().internal;
              return (
                (H.priority = H.priority + (T > 0 ? 1 : 0)),
                H.subscribers.push({ ref: C, priority: T, store: D }),
                (H.subscribers = H.subscribers.sort(
                  (b, X) => b.priority - X.priority,
                )),
                () => {
                  const b = p().internal;
                  b != null &&
                    b.subscribers &&
                    ((b.priority = b.priority - (T > 0 ? 1 : 0)),
                    (b.subscribers = b.subscribers.filter((X) => X.ref !== C)));
                }
              );
            },
          },
    ...
    return (
      l.subscribe(() => {
        const { camera: g, size: p, viewport: y, gl: v, set: h } = l.getState();
        if (p.width !== c.width || p.height !== c.height || y.dpr !== d) {
          var S;
          ((c = p), (d = y.dpr), Au(g, p), v.setPixelRatio(y.dpr));
          const x =
            (S = p.updateStyle) != null
              ? S
              : typeof HTMLCanvasElement < "u" &&
                v.domElement instanceof HTMLCanvasElement;
          v.setSize(p.width, p.height, x);
        }
        g !== f &&
          ((f = g),
          h((x) => ({
            viewport: { ...x.viewport, ...x.viewport.getCurrentViewport(g) },
          })));
      }),
      l.subscribe((g) => n(g)),
      l
...
let Si,
  ...
  wp = new Set();
function $s(n, r) {
  if (n.size) for (const { callback: l } of n.values()) l(r);
}
function hr(n, r) {
  switch (n) {
    case "before":
...
function nl(n, r, l) {
  ...
  for (
    r.frameloop === "never" &&
      typeof n == "number" &&
      ((a = n - r.clock.elapsedTime),
      (r.clock.oldTime = r.clock.elapsedTime),
      (r.clock.elapsedTime = n)),
      el = r.internal.subscribers,
      Si = 0;
    Si < el.length;
    Si++
  )
    ((tl = el[Si]), tl.ref.current(tl.store.getState(), a, l));
  return (
...
function Tp(n) {
  let r = !1,
    ...
    c;
  function d(p) {
    ((a = requestAnimationFrame(d)), (r = !0), (l = 0), hr("before", p));
    for (const v of n.values()) {
      var y;
      ((c = v.store.getState()),
        c.internal.active &&
          (c.frameloop === "always" || c.internal.frames > 0) &&
          !((y = c.gl.xr) != null && y.isPresenting) &&
          (l += nl(p, c)));
    }
    if ((hr("after", p), l === 0))
      return (hr("tail", p), (r = !1), cancelAnimationFrame(a));
  }
  function f(p, y = 1) {
    var v;
    if (!p) return n.forEach((h) => f(h.store.getState()), y);
    ((v = p.gl.xr) != null && v.isPresenting) ||
      !p.internal.active ||
      p.frameloop === "never" ||
      ((p.internal.frames = Math.min(60, p.internal.frames + y)),
      r || ((r = !0), requestAnimationFrame(d)));
  }
  function g(p, y = !0, v, h) {
    if ((y && hr("before", p), v)) nl(p, v, h);
    else for (const S of n.values()) nl(p, S.store.getState());
    y && hr("after", p);
  }
  return { loop: d, invalidate: f, advance: g };
}
function Mp(n) {
...
const Nn = new Map(),
  { invalidate: Fa, advance: Ha } = Tp(Nn),
  { reconciler: mr, applyProps: Cn } = cp(Nn, mp),
  Un = { objects: "shallow", strict: !1 },
  Rp = (n, r) => {
...
function Pp(n, r) {
  ...
  if (r) {
    const { width: a, height: c, top: d, left: f, updateStyle: g = l } = r;
    return { width: a, height: c, top: d, left: f, updateStyle: g };
  } else if (
    typeof HTMLCanvasElement < "u" &&
    ...
    return { width: a, height: c, top: d, left: f, updateStyle: l };
...
function Cp(n) {
  ...
  const c = typeof reportError == "function" ? reportError : console.error,
    ...
    f =
      l ||
      mr.createContainer(d, zn.ConcurrentRoot, null, !1, null, "", c, null);
  r || Nn.set(n, { fiber: f, store: d });
  let g,
    p = !1,
    y;
  return {
    configure(v = {}) {
      let {
        ...
        A = d.getState(),
        Y = A.gl;
      A.gl || A.set({ gl: (Y = Rp(h, n)) });
      let ae = A.raycaster;
      ae || A.set({ raycaster: (ae = new lu()) });
      const { params: se, ...Ee } = V || {};
      if (
        (we.equ(Ee, ae, Un) || Cn(ae, { ...Ee }),
        we.equ(se, ae.params, Un) ||
          Cn(ae, { params: { ...ae.params, ...se } }),
        ...
        const K = q instanceof vl,
          ue = K
            ? q
            : H
              ? new Jf(0, 0, 0, 0, 0.1, 1e3)
              : new iu(75, 0, 0.1, 1e3);
        (K ||
          ((ue.position.z = 5),
          q && Cn(ue, q),
          !A.camera && !(q != null && q.rotation) && ue.lookAt(0, 0, 0)),
          A.set({ camera: ue }),
          (ae.camera = ue));
      }
      if (!A.scene) {
        let K;
        (x instanceof pr ? (K = x) : ((K = new pr()), x && Cn(K, x)),
          A.set({ scene: Ln(K) }));
      }
      if (!A.xr) {
        var ge;
        const K = (ee, pe) => {
          ...
          ue = () => {
            ...
            ((ee.gl.xr.enabled = ee.gl.xr.isPresenting),
              ee.gl.xr.setAnimationLoop(ee.gl.xr.isPresenting ? K : null),
              ee.gl.xr.isPresenting || Fa(ee));
          },
          ve = {
            connect() {
              const ee = d.getState().gl;
              (ee.xr.addEventListener("sessionstart", ue),
                ee.xr.addEventListener("sessionend", ue));
            },
            disconnect() {
              const ee = d.getState().gl;
              (ee.xr.removeEventListener("sessionstart", ue),
                ee.xr.removeEventListener("sessionend", ue));
            },
          };
        (typeof ((ge = Y.xr) == null ? void 0 : ge.addEventListener) ==
          "function" && ve.connect(),
          A.set({ xr: ve }));
      }
      if (Y.shadowMap) {
        ...
        if (((Y.shadowMap.enabled = !!I), we.boo(I))) Y.shadowMap.type = Vs;
          ...
          var Ce;
          const ve = { basic: nd, percentage: rd, soft: Vs, variance: id };
          Y.shadowMap.type = (Ce = ve[I]) != null ? Ce : Vs;
        } else we.obj(I) && Object.assign(Y.shadowMap, I);
        (K !== Y.shadowMap.enabled || ue !== Y.shadowMap.type) &&
      ...
      (M &&
        ("enabled" in M
          ? (M.enabled = !D)
          : "legacyMode" in M && (M.legacyMode = D)),
        Cn(Y, { outputEncoding: C ? 3e3 : 3001, toneMapping: T ? $f : ed }),
        A.legacy !== D && A.set(() => ({ legacy: D })),
        A.linear !== C && A.set(() => ({ linear: C })),
        A.flat !== T && A.set(() => ({ flat: T })),
        h && !we.fun(h) && !Nu(h) && !we.equ(h, Y, Un) && Cn(Y, h),
        w && !A.events.handlers && A.set({ events: w(d) }));
      const W = Pp(n, S);
      return (
        we.equ(W, A.size, Un) ||
          A.setSize(W.width, W.height, W.updateStyle, W.top, W.left),
        X && A.viewport.dpr !== Iu(X) && A.setDpr(X),
        A.frameloop !== b && A.setFrameloop(b),
        A.onPointerMissed || A.set({ onPointerMissed: k }),
        te &&
          !we.equ(te, A.performance, Un) &&
          A.set((K) => ({ performance: { ...K.performance, ...te } })),
        (g = z),
        (p = !0),
        this
      );
...
function Up({ store: n, children: r, onCreated: l, rootElement: a }) {
  return (
    kn(() => {
      const c = n.getState();
    ...
    P.createElement(El.Provider, { value: n }, r)
  );
}
function Ou(n, r) {
  const l = Nn.get(n),
  ...
  if (a) {
    ...
    (c && (c.internal.active = !1),
      mr.updateContainer(null, a, null, () => {
        c &&
          setTimeout(() => {
            try {
              var d, f, g, p;
              (c.events.disconnect == null || c.events.disconnect(),
                (d = c.gl) == null ||
                  (f = d.renderLists) == null ||
                  f.dispose == null ||
                  f.dispose(),
                (g = c.gl) == null ||
                  g.forceContextLoss == null ||
                  g.forceContextLoss(),
                (p = c.gl) != null && p.xr && c.xr.disconnect(),
                pp(c),
                Nn.delete(n),
                r && r(n));
            } catch {}
...
function Lp({ state: n = {}, children: r, container: l }) {
  const { events: a, size: c, ...d } = n,
    f = _l(),
    [g] = P.useState(() => new lu()),
    [p] = P.useState(() => new Se()),
    y = P.useCallback(
      (h, S) => {
        ...
        Object.keys(h).forEach((z) => {
          (Sp.includes(z) || (h[z] !== S[z] && S[z])) && delete x[z];
        });
        let w;
        if (S && c) {
          const z = S.camera;
          ((w = h.viewport.getCurrentViewport(z, new Ne(), c)),
            z !== h.camera && Au(z, c));
        }
        return {
          ...x,
          ...
          mouse: p,
          previousRoot: f,
          events: { ...h.events, ...(S == null ? void 0 : S.events), ...a },
          size: { ...h.size, ...c },
    ...
    [v] = P.useState(() => {
      ...
      return _u((x, w) => ({
        ...
        set: x,
        get: w,
        setEvents: (z) => x((I) => ({ ...I, events: { ...I.events, ...z } })),
      }));
    });
  return (
    P.useEffect(() => {
      const h = f.subscribe((S) => v.setState((x) => y(S, x)));
      return () => {
        (h(), v.destroy());
      };
    }, []),
    P.useEffect(() => {
      v.setState((h) => y(f.getState(), h));
    }, [y]),
    P.createElement(
      P.Fragment,
      null,
      mr.createPortal(P.createElement(El.Provider, { value: v }, r), v, null),
    )
  );
}
...
function al(n, r, l) {
  ...
  function p() {
    ...
    v < r && v >= 0
      ? (a = setTimeout(p, r - v))
      : ((a = null), l || ((g = n.apply(d, c)), (d = c = null)));
  }
  var y = function () {
...
function Ip(n) {
  ...
  const [f, g] = P.useState({
    ...
    y = r ? (typeof r == "number" ? r : r.scroll) : null,
    v = r ? (typeof r == "number" ? r : r.resize) : null,
    h = P.useRef(!1);
  P.useEffect(() => ((h.current = !0), () => void (h.current = !1)));
  const [S, x, w] = P.useMemo(() => {
    const T = () => {
      ...
      (p.current.element instanceof HTMLElement &&
        c &&
        ((A.height = p.current.element.offsetHeight),
        (A.width = p.current.element.offsetWidth)),
        Object.freeze(A),
        h.current &&
          !Np(p.current.lastBounds, A) &&
          g((p.current.lastBounds = A)));
    };
    return [T, v ? Ga(T, v) : T, y ? Ga(T, y) : T];
  }, [g, c, y, v]);
  function z() {
    (p.current.scrollContainers &&
      (p.current.scrollContainers.forEach((T) =>
        T.removeEventListener("scroll", w, !0),
      ),
  ...
  function I() {
    p.current.element &&
      ((p.current.resizeObserver = new d(w)),
      p.current.resizeObserver.observe(p.current.element),
      l &&
        p.current.scrollContainers &&
        p.current.scrollContainers.forEach((T) =>
          T.addEventListener("scroll", w, { capture: !0, passive: !0 }),
        ));
  }
  const C = (T) => {
    !T ||
      T === p.current.element ||
      (z(), (p.current.element = T), (p.current.scrollContainers = ku(T)), I());
  };
  return (
    Ap(w, !!l),
    zp(x),
...
function Ap(n, r) {
  P.useEffect(() => {
    if (r) {
      const l = n;
      return (
        window.addEventListener("scroll", l, { capture: !0, passive: !0 }),
...
function ku(n) {
  ...
  return (
    [l, a, c].some((d) => d === "auto" || d === "scroll") && r.push(n),
    [...r, ...ku(n.parentElement)]
  );
}
const Bp = ["x", "y", "top", "bottom", "left", "right", "width", "height"],
  Np = (n, r) => Bp.every((l) => n[l] === r[l]);
var Op = Object.defineProperty,
  ...
  ba = (n, r, l) =>
    r in n
      ? Op(n, r, { enumerable: !0, configurable: !0, writable: !0, value: l })
      : (n[r] = l),
  Va = (n, r) => {
    for (var l in r || (r = {})) Hp.call(r, l) && ba(n, l, r[l]);
    if (ja) for (var l of ja(r)) Gp.call(r, l) && ba(n, l, r[l]);
    return n;
  },
  jp = (n, r) => kp(n, Fp(r));
function Fu(n, r, l) {
...
const Tl = Hu(P.createContext(null));
class Gu extends P.Component {
  render() {
...
const { ReactCurrentOwner: Wa, ReactCurrentDispatcher: Qa } =
...
function Vp() {
  ...
  for (; c; ) {
    ...
    (d &&
      ...
      a.set(
        d,
        (r = Qa == null ? void 0 : Qa.current) == null
          ? void 0
          : r.readContext(Hu(d)),
      ),
      (c = c.return));
      ...
      Array.from(n.keys()).reduce(
        (r, l) => (a) =>
          P.createElement(
            r,
            null,
            P.createElement(l.Provider, jp(Va({}, a), { value: n.get(l) })),
          ),
        (r) => P.createElement(Gu, Va({}, r)),
      ),
    [n],
  );
}
...
function Qp(n) {
  const { handlePointer: r } = yp(n);
  return {
    priority: 1,
    enabled: !0,
    compute(l, a, c) {
      (a.pointer.set(
        (l.offsetX / a.size.width) * 2 - 1,
        -(l.offsetY / a.size.height) * 2 + 1,
      ),
        a.raycaster.setFromCamera(a.pointer, a.camera));
    },
    connected: void 0,
    handlers: Object.keys(rl).reduce((l, a) => ({ ...l, [a]: r(a) }), {}),
    update: () => {
      var l;
      const { events: a, internal: c } = n.getState();
      (l = c.lastEvent) != null &&
        l.current &&
        a.handlers &&
    ...
    connect: (l) => {
      var a;
      const { set: c, events: d } = n.getState();
      (d.disconnect == null || d.disconnect(),
        c((f) => ({ events: { ...f.events, connected: l } })),
        Object.entries((a = d.handlers) != null ? a : []).forEach(([f, g]) => {
          const [p, y] = rl[f];
          l.addEventListener(p, g, { passive: y });
        }));
    },
    disconnect: () => {
      const { set: l, events: a } = n.getState();
      if (a.connected) {
        var c;
        (Object.entries((c = a.handlers) != null ? c : []).forEach(([d, f]) => {
          ...
          l((d) => ({ events: { ...d.events, connected: void 0 } })));
      }
    },
  };
}
const Xp = P.forwardRef(function (
    {
      children: r,
      fallback: l,
      resize: a,
    ...
    P.useMemo(() => Ru(ld), []);
    const V = Wp(),
      [q, k] = Ip({ scroll: !0, debounce: { scroll: 50, resize: 0 }, ...a }),
      A = P.useRef(null),
      Y = P.useRef(null);
    ...
    (kn(() => {
      ...
      k.width > 0 &&
        ...
        M.current.configure({
          ...
          size: k,
          onPointerMissed: (...W) =>
            ae.current == null ? void 0 : ae.current(...W),
          onCreated: (W) => {
            (W.events.connect == null ||
              W.events.connect(g ? (fp(g) ? g.current : g) : Y.current),
              p &&
                W.setEvents({
                  compute: (K, ue) => {
                    const ve = K[p + "X"],
                      ee = K[p + "Y"];
                    (ue.pointer.set(
                      (ve / ue.size.width) * 2 - 1,
                      -(ee / ue.size.height) * 2 + 1,
                    ),
        ...
        M.current.render(
          P.createElement(
            ...
            P.createElement(
              ...
              P.createElement(
                P.Suspense,
                { fallback: P.createElement(dp, { set: Ee }) },
                r,
              ),
            ),
          ),
    ...
    return P.createElement(
      ...
      P.createElement(
        "div",
        { ref: q, style: { width: "100%", height: "100%" } },
        P.createElement("canvas", { ref: A, style: { display: "block" } }, l),
      ),
    );
  }),
  og = P.forwardRef(function (r, l) {
    return P.createElement(
      Gu,
      null,
      P.createElement(Xp, qt({}, r, { ref: l })),
    );
  });
function ju(n) {
  return function (r) {
...
function Kp(n, r) {
  ...
  for (let a = 0; a < l.length; a++)
    if (
      !Object.prototype.hasOwnProperty.call(r, l[a]) ||
      !Object.is(n[l[a]], r[l[a]])
    )
      return !1;
  return !0;
}
const Yp = P.createContext([]);
function ag({
  box: n,
  multiple: r,
  children: l,
  ...
  const X = P.useCallback((q) => {
      (q.stopPropagation(),
        b({ object: g([q.object])[0], shift: r && q.shiftKey }));
    }, []),
  ...
  return (
    P.useEffect(() => {
      if (!n || !r) return;
      const q = new fd(S, V.current),
        k = document.createElement("div");
      ((k.style.pointerEvents = "none"),
        (k.style.border = d),
        (k.style.backgroundColor = f),
      ...
      let ge = !1;
      function Ce(ee, pe) {
        const { offsetX: Re, offsetY: Ii } = ee,
          { width: jn, height: hn } = I;
      ...
      function M(ee) {
        ...
        (z && (z.enabled = !1),
          h({ enabled: !1 }),
          v((ge = !0)),
          (pe = w.domElement.parentElement) == null || pe.appendChild(k),
          (k.style.left = `${ee.clientX}px`),
          (k.style.top = `${ee.clientY}px`),
          (k.style.width = "0px"),
          (k.style.height = "0px"),
          (A.x = ee.clientX),
          (A.y = ee.clientY));
      ...
      function B(ee) {
        ((ae.x = Math.max(A.x, ee.clientX)),
          (ae.y = Math.max(A.y, ee.clientY)),
          (Y.x = Math.min(A.x, ee.clientX)),
          (Y.y = Math.min(A.y, ee.clientY)),
          (k.style.left = `${Y.x}px`),
          (k.style.top = `${Y.y}px`),
          (k.style.width = `${ae.x - Y.x}px`),
          (k.style.height = `${ae.y - Y.y}px`));
      }
      function N() {
        if (ge) {
          var ee;
          (z && (z.enabled = Ee),
            h({ enabled: se }),
            v((ge = !1)),
            (ee = k.parentElement) == null || ee.removeChild(k));
        }
      }
      function W(ee) {
      ...
      return (
        document.addEventListener("pointerdown", W, { passive: !0 }),
        document.addEventListener("pointermove", ue, {
          passive: !0,
          capture: !0,
        }),
        document.addEventListener("pointerup", ve, { passive: !0 }),
        () => {
    ...
    P.createElement(
      ...
      P.createElement(Yp.Provider, { value: H }, l),
    )
  );
}
const Zp = P.forwardRef(function (
    {
      points: r,
      color: l = "black",
      vertexColors: a,
    ...
    const v = dt((w) => w.size),
      h = P.useMemo(() => (f ? new dd() : new hd()), [f]),
      [S] = P.useState(() => new pd()),
      x = P.useMemo(() => {
        const w = f ? new vd() : new md(),
          z = r.map((I) => {
    ...
    return (
      ...
      P.useLayoutEffect(() => {
        (g ? (S.defines.USE_DASH = "") : delete S.defines.USE_DASH,
          (S.needsUpdate = !0));
      }, [g, S]),
      P.useEffect(() => () => x.dispose(), [x]),
      P.createElement(
        "primitive",
        qt({ object: h, ref: y }, p),
        P.createElement("primitive", { object: x, attach: "geometry" }),
        P.createElement(
          "primitive",
          qt(
            {
  ...
  ug = P.forwardRef(function (
    ...
    const g = P.useRef(null),
      [p] = P.useState(() => new od(void 0, void 0, void 0)),
      y = P.useCallback(
        (h, S, x, w = 20) => (
          h instanceof Ne ? p.v0.copy(h) : p.v0.set(...h),
          S instanceof Ne ? p.v2.copy(S) : p.v2.set(...S),
          x instanceof Ne
            ? p.v1.copy(x)
            : Array.isArray(x)
              ? p.v1.set(...x)
              : p.v1.copy(
                  p.v0
                    .clone()
                    .add(p.v2.clone().sub(p.v0))
                    .add(qp.set(0, p.v0.y - p.v2.y, 0)),
                ),
          p.getPoints(w)
        ),
        [],
    ...
    P.useLayoutEffect(() => {
      g.current.setPoints = (h, S, x) => {
        const w = y(h, S, x);
        g.current.geometry &&
          g.current.geometry.setPositions(w.map((z) => z.toArray()).flat());
      };
    }, []);
    const v = P.useMemo(() => y(r, l, a, c), [r, l, a, c]);
    return P.createElement(Zp, qt({ ref: ju([g, f]), points: v }, d));
  });
function fg(n, r, l, a) {
  const c = class extends St {
    constructor(f = {}) {
      ...
      (super({
        uniforms: g.reduce((p, [y, v]) => {
          const h = ad.clone({ [y]: { value: v } });
          return { ...p, ...h };
        }, {}),
        vertexShader: r,
        fragmentShader: l,
  ...
  return ((c.key = ou.generateUUID()), c);
}
const Jp = () => parseInt(Ri.replace(/\D+/g, "")),
  $p = Jp();
var ev = 1 / 0,
  tv = 9007199254740991,
  nv = "[object Arguments]",
  ...
  sv = "[object Symbol]",
  lv = typeof Zt == "object" && Zt && Zt.Object === Object && Zt,
  ov = typeof self == "object" && self && self.Object === Object && self,
  av = lv || ov || Function("return this")();
function uv(n, r, l) {
  switch (l.length) {
    case 0:
      return n.call(r);
...
function cv(n, r) {
  for (var l = -1, a = n ? n.length : 0, c = Array(a); ++l < a; )
    c[l] = r(n[l], l, n);
  return c;
}
function fv(n, r) {
...
function mv(n, r) {
  return (
    (r = Ya(r === void 0 ? n.length - 1 : r, 0)),
    function () {
      for (
        var l = arguments, a = -1, c = Ya(l.length - r, 0), d = Array(c);
        ++a < c;
      )
        d[a] = l[r + a];
      a = -1;
      for (var f = Array(r + 1); ++a < r; ) f[a] = l[a];
      return ((f[r] = d), uv(n, this, f));
    }
  );
}
function gv(n) {
  return xv(n) || Sv(n) || !!(Ka && n && n[Ka]);
}
function yv(n) {
  if (typeof n == "string" || Rv(n)) return n;
  var r = n + "";
  return r == "0" && 1 / n == -ev ? "-0" : r;
}
function Sv(n) {
  return (
    _v(n) && dv.call(n, "callee") && (!hv.call(n, "callee") || Rl.call(n) == nv)
  );
}
var xv = Array.isArray;
function Ev(n) {
  return n != null && Tv(n.length) && !wv(n);
}
function _v(n) {
  return Vu(n) && Ev(n);
}
function wv(n) {
  var r = Mv(n) ? Rl.call(n) : "";
  return r == rv || r == iv;
}
function Tv(n) {
  return typeof n == "number" && n > -1 && n % 1 == 0 && n <= tv;
}
function Mv(n) {
  var r = typeof n;
...
function Rv(n) {
  return typeof n == "symbol" || (Vu(n) && Rl.call(n) == sv);
}
var Pv = mv(function (n, r) {
    return n == null ? {} : pv(n, cv(bu(r, 1), yv));
  }),
  Cv = Pv;
const Uv = Mi(Cv);
var Lv = 200,
  ...
  Bv = "[object Symbol]",
  Nv = /[\\^$.*+?()[\]{}|]/g,
  Ov = /^\[object .+?Constructor\]$/,
  kv = /^(?:0|[1-9]\d*)$/,
  Fv = typeof Zt == "object" && Zt && Zt.Object === Object && Zt,
  Hv = typeof self == "object" && self && self.Object === Object && self,
  Cl = Fv || Hv || Function("return this")();
function Gv(n, r, l) {
  switch (l.length) {
    case 0:
      return n.call(r);
...
function bv(n, r, l) {
  for (var a = -1, c = n ? n.length : 0; ++a < c; ) if (l(r, n[a])) return !0;
  return !1;
}
function Qu(n, r) {
  for (var l = -1, a = n ? n.length : 0, c = Array(a); ++l < a; )
...
function Wv(n, r, l) {
  if (r !== r) return Vv(n, Qv, l);
  for (var a = l - 1, c = n.length; ++a < c; ) if (n[a] === r) return a;
  return -1;
}
function Qv(n) {
  return n !== n;
...
var Jv = Array.prototype,
  ...
  qa = Cl.Symbol,
  tm = Xu(Object.getPrototypeOf, Object),
  nm = Ci.propertyIsEnumerable,
  rm = Jv.splice,
...
fn.prototype.clear = sm;
fn.prototype.delete = lm;
fn.prototype.get = om;
fn.prototype.has = am;
fn.prototype.set = um;
function Hn(n) {
...
function fm(n) {
  ...
  if (l < 0) return !1;
  var a = r.length - 1;
  return (l == a ? r.pop() : rm.call(r, l, 1), !0);
}
function dm(n) {
  var r = this.__data__,
    l = Ui(r, n);
...
function vm() {
  this.__data__ = { hash: new fn(), map: new (im || Hn)(), string: new fn() };
}
function mm(n) {
...
Ti.prototype.add = Ti.prototype.push = xm;
Ti.prototype.has = Em;
function _m(n, r) {
  var l = Dl(n) || qu(n) ? Xv(n.length, String) : [],
    a = l.length,
    c = !!a;
  for (var d in n)
    (r || Fn.call(n, d)) && !(c && (d == "length" || Am(d, a))) && l.push(d);
  return l;
}
function Ui(n, r) {
  for (var l = n.length; l--; ) if (Gm(n[l][0], r)) return l;
  return -1;
}
function wm(n, r, l, a) {
  var c = -1,
  ...
  (l && (r = Qu(r, Kv(l))),
    a
      ? ((d = bv), (f = !1))
      : r.length >= Lv && ((d = Yv), (f = !1), (r = new Ti(r))));
  e: for (; ++c < g; ) {
    var v = n[c],
      h = l ? l(v) : v;
    if (((v = a || v !== 0 ? v : 0), f && h === h)) {
      for (var S = y; S--; ) if (r[S] === h) continue e;
      p.push(v);
    } else d(r, h, a) || p.push(v);
  }
  return p;
}
function Yu(n, r, l, a, c) {
  var d = -1,
    f = n.length;
  for (l || (l = zm), c || (c = []); ++d < f; ) {
    var g = n[d];
...
function Mm(n) {
  if (!Il(n) || Nm(n)) return !1;
  var r = $u(n) || qv(n) ? em : Ov;
  return r.test(Hm(n));
}
function Rm(n) {
  if (!Il(n)) return km(n);
...
function Um(n, r) {
  return (
    (r = $a(r === void 0 ? n.length - 1 : r, 0)),
    function () {
      for (
        var l = arguments, a = -1, c = $a(l.length - r, 0), d = Array(c);
        ++a < c;
      )
        d[a] = l[r + a];
      a = -1;
      for (var f = Array(r + 1); ++a < r; ) f[a] = l[a];
      return ((f[r] = d), Gv(n, this, f));
    }
  );
}
function Lm(n) {
...
function Li(n, r) {
  var l = n.__data__;
  return Bm(r) ? l[typeof r == "string" ? "string" : "hash"] : l.map;
}
function Zu(n, r) {
  var l = Zv(n, r);
  return Mm(l) ? l : void 0;
}
var Dm = ul ? Xu(ul, Object) : tc,
  Im = ul
    ? function (n) {
        for (var r = []; n; ) (Ul(r, Dm(n)), (n = tm(n)));
        return r;
      }
    : tc;
function zm(n) {
  return Dl(n) || qu(n) || !!(Ja && n && n[Ja]);
}
function Am(n, r) {
  return (
    (r = r ?? Wu),
    !!r && (typeof n == "number" || kv.test(n)) && n > -1 && n % 1 == 0 && n < r
  );
}
function Bm(n) {
  var r = typeof n;
...
function km(n) {
  var r = [];
  if (n != null) for (var l in Object(n)) r.push(l);
  return r;
}
function Fm(n) {
  if (typeof n == "string" || Vm(n)) return n;
  var r = n + "";
  return r == "0" && 1 / n == -Dv ? "-0" : r;
}
function Hm(n) {
  if (n != null) {
    try {
...
function qu(n) {
  return (
    jm(n) && Fn.call(n, "callee") && (!nm.call(n, "callee") || Ll.call(n) == Iv)
  );
}
var Dl = Array.isArray;
function Ju(n) {
  return n != null && bm(n.length) && !$u(n);
}
function jm(n) {
  return ec(n) && Ju(n);
}
...
function bm(n) {
  return typeof n == "number" && n > -1 && n % 1 == 0 && n <= Wu;
}
function Il(n) {
  var r = typeof n;
  return !!n && (r == "object" || r == "function");
...
function Vm(n) {
  return typeof n == "symbol" || (ec(n) && Ll.call(n) == Bv);
}
function Wm(n) {
  return Ju(n) ? _m(n, !0) : Rm(n);
}
var Qm = Um(function (n, r) {
  return n == null ? {} : ((r = Qu(Yu(r, 1), Fm)), Pm(n, wm(Lm(n), r)));
});
function tc() {
  return [];
}
  ...
  dg = P.forwardRef(
    (
      ...
      const v = [
        ...
        V = P.useMemo(() => new gd(X, te), [X, te]),
        q = P.useRef();
      (P.useLayoutEffect(
        () => (
          f
            ? V.attach(f instanceof wi ? f : f.current)
            : q.current instanceof wi && V.attach(q.current),
          () => void V.detach()
        ),
        [f, n, V],
      ),
        P.useEffect(() => {
          if (z) {
            ...
            return (
              V.addEventListener("dragging-changed", se),
              () => V.removeEventListener("dragging-changed", se)
            );
          }
        }, [V, z]));
      const k = P.useRef(),
        ...
        ae = P.useRef();
      return (
        P.useLayoutEffect(() => void (k.current = l), [l]),
        P.useLayoutEffect(() => void (A.current = a), [a]),
        P.useLayoutEffect(() => void (Y.current = c), [c]),
        P.useLayoutEffect(() => void (ae.current = d), [d]),
        P.useEffect(() => {
          const se = (M) => {
          ...
          return (
            V.addEventListener("change", se),
            V.addEventListener("mouseDown", Ee),
            V.addEventListener("mouseUp", ge),
            V.addEventListener("objectChange", Ce),
            () => {
              (V.removeEventListener("change", se),
                V.removeEventListener("mouseDown", Ee),
                V.removeEventListener("mouseUp", ge),
                V.removeEventListener("objectChange", Ce));
            }
          );
        }, [D, V]),
        P.useEffect(() => {
          if (g) {
            const se = H().controls;
            return (b({ controls: V }), () => b({ controls: se }));
          }
        }, [g, V]),
        V
          ? P.createElement(
              P.Fragment,
              null,
              P.createElement("primitive", qt({ ref: y, object: V }, x)),
              P.createElement("group", qt({ ref: q }, w), n),
            )
          : null
      );
    },
      ...
      l.map((d) => {
        ...
        if (!!a)
          for (let v = c.length - 1; v >= 0; v--) {
            const h = c[v];
            if (h.href === d && (!f || h.rel === "stylesheet")) return;
          }
        else if (document.querySelector(`link[href="${d}"]${g}`)) return;
        const y = document.createElement("link");
        if (
          ((y.rel = f ? "stylesheet" : Ym),
          f || ((y.as = "script"), (y.crossOrigin = "")),
          (y.href = d),
...
function pg(n, r) {
  const l = P.useRef(),
    [a] = P.useState(() => (r ? (r instanceof wi ? { current: r } : r) : l)),
    [c] = P.useState(() => new ud(void 0));
  P.useLayoutEffect(() => {
  ...
  const d = P.useRef({}),
    f = P.useMemo(() => {
      ...
      return (
        n.forEach((p) =>
          Object.defineProperty(g, p.name, {
            enumerable: !0,
            get() {
              if (a.current)
                return (
                  d.current[p.name] ||
                  (d.current[p.name] = c.clipAction(p, a.current))
                );
            },
            configurable: !0,
          }),
        ),
        { ref: a, clips: n, actions: g, names: n.map((p) => p.name), mixer: c }
      );
    }, [n]);
  return (
    wl((g, p) => c.update(p)),
...
class qm extends St {
  constructor(r = new Se()) {
    (super({
      uniforms: {
        ...
        depthScale: new Q(0),
        depthToBlurRatioBias: new Q(0.25),
      },
  ...
  setTexelSize(r, l) {
    (this.uniforms.texelSize.value.set(r, l),
      this.uniforms.halfTexelSize.value.set(r, l).multiplyScalar(0.5));
  }
  setResolution(r) {
...
class vg {
  constructor({
    ...
    depthScale: g = 0,
    depthToBlurRatioBias: p = 0.25,
  }) {
    ((this.renderToScreen = !1),
      (this.renderTargetA = new rt(l, l, {
        minFilter: ht,
        magFilter: ht,
        stencilBuffer: !1,
        depthBuffer: !1,
      ...
      (this.renderTargetB = this.renderTargetA.clone()),
      (this.convolutionMaterial = new qm()),
      this.convolutionMaterial.setTexelSize(1 / a, 1 / c),
      this.convolutionMaterial.setResolution(new Se(a, c)),
      (this.scene = new pr()),
      (this.camera = new vl()),
      (this.convolutionMaterial.uniforms.minDepthThreshold.value = d),
      (this.convolutionMaterial.uniforms.maxDepthThreshold.value = f),
      (this.convolutionMaterial.uniforms.depthScale.value = g),
      (this.convolutionMaterial.uniforms.depthToBlurRatioBias.value = p),
      (this.convolutionMaterial.defines.USE_DEPTH = g > 0));
    const y = new Float32Array([-1, -1, 0, 3, -1, 0, -1, 3, 0]),
      v = new Float32Array([0, 0, 2, 0, 0, 2]),
      h = new ml();
    (h.setAttribute("position", new In(y, 3)),
      h.setAttribute("uv", new In(v, 2)),
      (this.screen = new su(h, this.convolutionMaterial)),
  ...
  render(r, l, a) {
    ...
    let p = this.convolutionMaterial,
      y = p.uniforms;
    ...
    let h = l,
      ...
      x,
      w;
    for (x = 0, w = v.length - 1; x < w; ++x)
      ((S = x & 1 ? g : f),
        (y.kernel.value = v[x]),
        (y.inputBuffer.value = h.texture),
        r.setRenderTarget(S),
        r.render(c, d),
        (h = S));
    ((y.kernel.value = v[x]),
      (y.inputBuffer.value = h.texture),
      r.setRenderTarget(this.renderToScreen ? null : a),
      r.render(c, d));
  }
}
class mg extends cd {
  ...
  onBeforeCompile(r) {
    var l;
    (((l = r.defines) != null && l.USE_UV) || (r.defines.USE_UV = ""),
      (r.uniforms.hasBlur = this._hasBlur),
      (r.uniforms.tDiffuse = this._tDiffuse),
      (r.uniforms.tDepth = this._tDepth),
      (r.uniforms.distortionMap = this._distortionMap),
      (r.uniforms.tDiffuseBlur = this._tDiffuseBlur),
      (r.uniforms.textureMatrix = this._textureMatrix),
      (r.uniforms.mirror = this._mirror),
      (r.uniforms.mixBlur = this._mixBlur),
      (r.uniforms.mixStrength = this._blurStrength),
      (r.uniforms.minDepthThreshold = this._minDepthThreshold),
      (r.uniforms.maxDepthThreshold = this._maxDepthThreshold),
      (r.uniforms.depthScale = this._depthScale),
      (r.uniforms.depthToBlurRatioBias = this._depthToBlurRatioBias),
      (r.uniforms.distortion = this._distortion),
      (r.uniforms.mixContrast = this._mixContrast),
      (r.vertexShader = `
...
const gg = P.forwardRef(
    (
      ...
      return (
        wl((v) => {
          ...
          ((p.current.rotation.x = (Math.cos((x / 4) * l) / 8) * a),
            (p.current.rotation.y = (Math.sin((x / 4) * l) / 8) * a),
            (p.current.rotation.z = (Math.sin((x / 4) * l) / 20) * a));
          let w = Math.sin((x / 4) * l) / 10;
          ((w = ou.mapLinear(
            w,
            -0.1,
            0.1,
            (h = d == null ? void 0 : d[0]) !== null && h !== void 0 ? h : -0.1,
            (S = d == null ? void 0 : d[1]) !== null && S !== void 0 ? S : 0.1,
          )),
            (p.current.position.y = w * c),
            p.current.updateMatrix());
        }),
        P.createElement(
          "group",
          f,
  ...
  Jm = P.createContext(null),
  tu = (n) => (n.getAttributes() & Pt.CONVOLUTION) === Pt.CONVOLUTION,
  yg = sl.memo(
    P.forwardRef(
      (
        {
          ...
          stencilBuffer: y,
          multisampling: v = 8,
          frameBufferType: h = pl,
        },
        S,
      ) => {
        const { gl: x, scene: w, camera: z, size: I } = dt(),
          C = l || w,
          T = r || z,
          [D, H, b] = P.useMemo(() => {
            const q = yd(),
        ...
        (P.useEffect(
          () => (D == null ? void 0 : D.setSize(I.width, I.height)),
          [D, I],
        ),
          wl(
            (q, k) => {
          ...
          if (X.current && te.current && D) {
            ...
            for (let A = 0; A < k.length; A++) {
              ...
              if (Y instanceof $t) {
                ...
                if (!tu(Y)) {
                  let Ee = null;
                  for (; (Ee = k[A + 1]) instanceof $t && !tu(Ee); )
                    (ae.push(Ee), A++);
                }
                const se = new eh(T, ...ae);
                q.push(se);
        ...
        return (
          P.useImperativeHandle(S, () => D, [D]),
          vr.jsx(Jm.Provider, {
            value: V,
            children: vr.jsx("group", { ref: X, children: n }),
          })
        );
      },
    ),
...
const nu = new WeakMap(),
  Di = (n, r) =>
    sl.forwardRef(function (
      ...
      let g = nu.get(n);
      if (!g) {
        const v = `@react-three/postprocessing/${n.name}-${$m++}`;
        (Ru({ [v]: n }), nu.set(n, (g = v)));
      }
      const p = dt((v) => v.camera),
        y = sl.useMemo(() => {
          var v, h;
          return [
            ...((v = r == null ? void 0 : r.args) != null ? v : []),
            ...((h = d.args) != null ? h : [{ ...r, ...d }]),
          ];
        }, [JSON.stringify(d)]);
      return vr.jsx(g, {
  ...
  Sg = Di(Vh, { blendFunction: ie.ADD }),
  xg = Di(Kh),
  Eg = Di(Jh, { blendFunction: ie.COLOR_DODGE }),
  _g = P.forwardRef(function (
    {
      blendFunction: r,
      adaptive: l,
      mode: a,
  ...
  wg = Di(np),
  Tg = P.forwardRef(function (
    { lut: r, tetrahedralInterpolation: l, ...a },
    c,
  ) {
    const d = P.useMemo(() => new Zh(r, a), [r, a]),
      f = dt((g) => g.invalidate);
    return (
      P.useLayoutEffect(() => {
        (l && (d.tetrahedralInterpolation = l), r && (d.lut = r), f());
      }, [d, f, r, l]),
      vr.jsx("primitive", { ref: c, object: d, dispose: null })
    );
  });
export {
  Sg as B,
